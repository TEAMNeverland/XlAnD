...
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/RapEthan/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) end
if text == "راب" then
if not Redis:get(TheXlAnD.."XlAnD:Status:distraction1"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"✦┇عذراً امر غنيلي معطل","md",true) end 
Abs = math.random(4,2824); 
local Text ='✦┇تم اختيار هذا الراب لك'
keyboard = {} 
...
--
if Text and Text:match('(%d+)/rab') then
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = URL.escape(ta.title_),url=link}}}
local msg_id = Msg_id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token..'/editMessageText?chat_id='..ChatId..'&message_id='..msg_id..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
local LinkGroup = json:decode(https.request('https://api.telegram.org/bot'..Token..'/exportChatInviteLink?chat_id='..data.chat_id))
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = URL.escape(ta.title_),url=linkgpp.result}}}
local msg_id = Msg_id/2097152/0.5
return https.request("https://api.telegram.org/bot"..Token..'/editMessageText?chat_id='..ChatId..'&message_id='..msg_id..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
