------------------------------------------------
-- This Source Was Developed By (XlAnD) @XCGCC.--
...
cd $(cd $(dirname $0); pwd)
while(true) do
screen -S TheXlAnD -X kill
screen -S TheXlAnD ./TheXlAnD
done
]])
Run:close()
Redis:del(SshId.."Info:Redis:User:ID");Redis:del(SshId.."Info:Redis:User");Redis:del(SshId.."Info:Redis:Token:User");Redis:del(SshId.."Info:Redis:Token")
os.execute('chmod +x TheXlAnD;chmod +x Run;./Run')
end
...
Status = Redis:get(TheXlAnD.."XlAnD:Developer:Bot:Reply"..ChatId) or 'المطور'
elseif TheBasicsQ then
Status = Redis:get(TheXlAnD.."XlAnD:PresidentQ:Group:Reply"..ChatId) or 'المالك'
elseif TheBasics then
Status = Redis:get(TheXlAnD.."XlAnD:President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(TheXlAnD.."XlAnD:Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(TheXlAnD.."XlAnD:Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(TheXlAnD.."XlAnD:Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك المجموعه'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن المجموعه'
elseif Distinguished then
Status = Redis:get(TheXlAnD.."XlAnD:Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(TheXlAnD.."XlAnD:Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(TheXlAnD.."XlAnD:lockpin"..ChatId) then    
lock_pin = "✔️"
else 
lock_pin = "❌"    
end
if Redis:get(TheXlAnD.."XlAnD:Lock:tagservr"..ChatId) then    
lock_tagservr = "✔️"
else 
lock_tagservr = "❌"
end
if Redis:get(TheXlAnD.."XlAnD:Lock:text"..ChatId) then    
lock_text = "✔️"
else 
lock_text = "❌ "    
end
if Redis:get(TheXlAnD.."XlAnD:Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✔️"
else 
lock_add = "❌ "    
end    
if Redis:get(TheXlAnD.."XlAnD:Lock:Join"..ChatId) == "kick" then
lock_join = "✔️"
else 
lock_join = "❌ "    
end    
if Redis:get(TheXlAnD.."XlAnD:Lock:edit"..ChatId) then    
lock_edit = "✔️"
else 
lock_edit = "❌ "    
end
if Redis:get(TheXlAnD.."XlAnD:Chek:Welcome"..ChatId) then
welcome = "✔️"
else 
welcome = "❌ "    
end
if Redis:hget(TheXlAnD.."XlAnD:Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(TheXlAnD.."XlAnD:Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(TheXlAnD.."XlAnD:Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(TheXlAnD.."XlAnD:Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✔️"
else     
flood = "❌ "     
end
if Redis:get(TheXlAnD.."XlAnD:Lock:Photo"..ChatId) == "del" then
lock_photo = "✔️" 
elseif Redis:get(TheXlAnD.."XlAnD:Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(TheXlAnD.."XlAnD:Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(TheXlAnD.."XlAnD:Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "❌ "   
end    
if Redis:get(TheXlAnD.."XlAnD:Lock:Contact"..ChatId) == "del" then
lock_phon = "✔️" 
elseif Redis:get(TheXlAnD.."XlAnD:Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(TheXlAnD.."XlAnD:Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(TheXlAnD.."XlAnD:Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "❌ "    
end    
if Redis:get(TheXlAnD.."XlAnD:Lock:Link"..ChatId) == "del" then
lock_links = "✔️"
elseif Redis:get(TheXlAnD.."XlAnD:Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(TheXlAnD.."XlAnD:Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(TheXlAnD.."XlAnD:Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "❌ "    
end
if Redis:get(TheXlAnD.."XlAnD:Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✔️"
elseif Redis:get(TheXlAnD.."XlAnD:Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(TheXlAnD.."XlAnD:Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(TheXlAnD.."XlAnD:Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "❌ "    
end
if Redis:get(TheXlAnD.."XlAnD:Lock:User:Name"..ChatId) == "del" then
lock_user = "✔️"
elseif Redis:get(TheXlAnD.."XlAnD:Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(TheXlAnD.."XlAnD:Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(TheXlAnD.."XlAnD:Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "❌ "    
end
if Redis:get(TheXlAnD.."XlAnD:Lock:hashtak"..ChatId) == "del" then
lock_hash = "✔️"
elseif Redis:get(TheXlAnD.."XlAnD:Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(TheXlAnD.."XlAnD:Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(TheXlAnD.."XlAnD:Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "❌ "    
end
if Redis:get(TheXlAnD.."XlAnD:Lock:vico"..ChatId) == "del" then
lock_muse = "✔️"
elseif Redis:get(TheXlAnD.."XlAnD:Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(TheXlAnD.."XlAnD:Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(TheXlAnD.."XlAnD:Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "❌ "    
end 
if Redis:get(TheXlAnD.."XlAnD:Lock:Video"..ChatId) == "del" then
lock_ved = "✔️"
elseif Redis:get(TheXlAnD.."XlAnD:Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(TheXlAnD.."XlAnD:Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(TheXlAnD.."XlAnD:Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "❌ "    
end
if Redis:get(TheXlAnD.."XlAnD:Lock:Animation"..ChatId) == "del" then
lock_gif = "✔️"
elseif Redis:get(TheXlAnD.."XlAnD:Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(TheXlAnD.."XlAnD:Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(TheXlAnD.."XlAnD:Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "❌ "    
end
if Redis:get(TheXlAnD.."XlAnD:Lock:Sticker"..ChatId) == "del" then
lock_ste = "✔️"
elseif Redis:get(TheXlAnD.."XlAnD:Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(TheXlAnD.."XlAnD:Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(TheXlAnD.."XlAnD:Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "❌ "    
end
if Redis:get(TheXlAnD.."XlAnD:Lock:geam"..ChatId) == "del" then
lock_geam = "✔️"
elseif Redis:get(TheXlAnD.."XlAnD:Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(TheXlAnD.."XlAnD:Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(TheXlAnD.."XlAnD:Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "❌ "    
end    
...
if Redis:get(TheXlAnD.."XlAnD:Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✔️"
elseif Redis:get(TheXlAnD.."XlAnD:Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(TheXlAnD.."XlAnD:Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(TheXlAnD.."XlAnD:Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "❌ "
end
if Redis:get(TheXlAnD.."XlAnD:Lock:forward"..ChatId) == "del" then
lock_fwd = "✔️"
elseif Redis:get(TheXlAnD.."XlAnD:Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(TheXlAnD.."XlAnD:Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(TheXlAnD.."XlAnD:Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "❌ "    
end    
if Redis:get(TheXlAnD.."XlAnD:Lock:Document"..ChatId) == "del" then
lock_file = "✔️"
elseif Redis:get(TheXlAnD.."XlAnD:Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(TheXlAnD.."XlAnD:Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(TheXlAnD.."XlAnD:Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "❌ "    
end    
if Redis:get(TheXlAnD.."XlAnD:Lock:Unsupported"..ChatId) == "del" then
lock_self = "✔️"
elseif Redis:get(TheXlAnD.."XlAnD:Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(TheXlAnD.."XlAnD:Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(TheXlAnD.."XlAnD:Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "❌ "    
end
if Redis:get(TheXlAnD.."XlAnD:Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✔️"
elseif Redis:get(TheXlAnD.."XlAnD:Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(TheXlAnD.."XlAnD:Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "❌ "    
end
if Redis:get(TheXlAnD.."XlAnD:Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✔️"
elseif Redis:get(TheXlAnD.."XlAnD:Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(TheXlAnD.."XlAnD:Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(TheXlAnD.."XlAnD:Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "❌ "    
end
if Redis:get(TheXlAnD.."XlAnD:Lock:Spam"..ChatId) == "del" then    
lock_spam = "✔️"
elseif Redis:get(TheXlAnD.."XlAnD:Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(TheXlAnD.."XlAnD:Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(TheXlAnD.."XlAnD:Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "❌ "    
end        
...
return{
BanAll = Redis:sismember(TheXlAnD.."XlAnD:BanAll:Groups",UserId) ,
BanGroup = Redis:sismember(TheXlAnD.."XlAnD:BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(TheXlAnD.."XlAnD:SilentGroup:Group"..ChatId,UserId)
}
end
...
return {
Lock     = '[𝖲𝗈𝗎𝗋𝖼𝖾 XlAnD](https://t.me/TeAm_XlAnD)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه المسح *',
unLock   = '[𝖲𝗈𝗎𝗋𝖼𝖾 XlAnD](https://t.me/TeAm_XlAnD)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[𝖲𝗈𝗎𝗋𝖼𝖾 XlAnD](https://t.me/TeAm_XlAnD)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الكتم *',
lockKid  = '[𝖲𝗈𝗎𝗋𝖼𝖾 XlAnD](https://t.me/TeAm_XlAnD)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه التقييد *',
lockKick = '[𝖲𝗈𝗎𝗋𝖼𝖾 XlAnD](https://t.me/TeAm_XlAnD)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الطرد *',
Reply    = '[𝖲𝗈𝗎𝗋𝖼𝖾 XlAnD](https://t.me/TeAm_XlAnD)\n*— — — — — — — — —\n᥀︙المستخدم ← *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,TheXlAnD).status
if GetMemberStatus.can_change_info then
...
if tonumber(msg.sender.user_id) == tonumber(TheXlAnD) then
...
elseif Redis:sismember(TheXlAnD.."XlAnD:DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(TheXlAnD.."XlAnD:Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(TheXlAnD.."XlAnD:Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(TheXlAnD.."XlAnD:TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(TheXlAnD.."XlAnD:PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(TheXlAnD.."XlAnD:TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(TheXlAnD.."XlAnD:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(TheXlAnD.."XlAnD:Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(TheXlAnD.."XlAnD:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(TheXlAnD.."XlAnD:Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(TheXlAnD.."XlAnD:Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(TheXlAnD.."XlAnD:Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(TheXlAnD.."XlAnD:Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(TheXlAnD.."XlAnD:Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(TheXlAnD.."XlAnD:Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(TheXlAnD) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(TheXlAnD.."XlAnD:Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(TheXlAnD.."XlAnD:Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
...
Num_Msg_Max = Redis:hget(TheXlAnD.."XlAnD:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
Redis:incr(TheXlAnD.."XlAnD:Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(TheXlAnD.."XlAnD:Lock:Contact"..msg_chat_id)
...
if Text_Filter then   
Redis:set(TheXlAnD.."XlAnD:Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
...
if text and (Redis:get(TheXlAnD..'XlAnD:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
...
Redis:set(TheXlAnD.."XlAnD:Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(TheXlAnD.."XlAnD:Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheXlAnD.."XlAnD:Add:Rd:Manager:Text"..test..msg_chat_id, text)  
end  
if msg.content.audio then
Redis:set(TheXlAnD.."XlAnD:Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(TheXlAnD.."XlAnD:Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
end
if msg.content.animation then
Redis:set(TheXlAnD.."XlAnD:Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
end
if msg.content.video_note then
Redis:set(TheXlAnD.."XlAnD:Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.video then
Redis:set(TheXlAnD.."XlAnD:Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
end
if msg.content.photo then
...
print(idPhoto)
Redis:set(TheXlAnD.."XlAnD:Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
end
...
{
{text = '𝖲𝗈𝗎𝗋𝖼𝖾 XlAnD ⁦', url='https://t.me/TeAm_XlAnD'},
},
}
}
...
if Redis:get(TheXlAnD.."XlAnD:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(TheXlAnD.."XlAnD:Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(TheXlAnD.."XlAnD:Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(TheXlAnD.."XlAnD:Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
end   
if msg.content.animation then   
Redis:set(TheXlAnD.."XlAnD:Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheXlAnD.."XlAnD:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content.audio then
Redis:set(TheXlAnD.."XlAnD:Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(TheXlAnD.."XlAnD:Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
end
if msg.content.video then
Redis:set(TheXlAnD.."XlAnD:Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
end
if msg.content.video_note then
Redis:set(TheXlAnD.."XlAnD:Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
Redis:set(TheXlAnD.."XlAnD:Add:Rd:Sudo:Photo"..test, idPhoto)  
end
...
Redis:del(TheXlAnD..'XlAnD:'..v..text)
end
...
Redis:set(TheXlAnD.."XlAnD:PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(TheXlAnD.."XlAnD:PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(TheXlAnD.."XlAnD:PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(TheXlAnD.."XlAnD:PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(TheXlAnD.."XlAnD:PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(TheXlAnD.."XlAnD:PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(TheXlAnD.."XlAnD:PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(TheXlAnD.."XlAnD:PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v,0,text,"md",true)
Redis:set(TheXlAnD.."XlAnD:PinMsegees:"..v,text)
end
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(TheXlAnD..'XlAnD:Channel:Join')}, },}}
...
if tonumber(TheXlAnD) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(TheXlAnD..'XlAnD:Num:User:Pv',v)  
end
X = 0
...
Redis:sadd(TheXlAnD.."XlAnD:TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(TheXlAnD.."XlAnD:Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(TheXlAnD.."XlAnD:Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(TheXlAnD.."XlAnD:Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(TheXlAnD.."XlAnD:Distinguished:Group"..GroupId,v)
end
end 
end
...
Redis:sadd(TheXlAnD.."XlAnD:Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(TheXlAnD.."XlAnD:Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(TheXlAnD.."XlAnD:Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(TheXlAnD.."XlAnD:TheBasics:Group"..idg,idASAS)
end;end
end
...
download('https://raw.githubusercontent.com/TeAm_XlAnD/XlAnD/main/XlAnD.lua','XlAnD.lua')
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ''..Redis:get(TheXlAnD..'XlAnD:Channel:Join:Name')..'', url = 't.me/'..Redis:get(TheXlAnD..'XlAnD:Channel:Join')}, },}}
...
db = "video_note@"..Redis:get(TheXlAnD.."XlAnD:Add:Rd:Manager:video_note"..v..ide)
end
v = string.gsub(v,'"','')
v = string.gsub(v,"'",'')
...
Redis:set(TheXlAnD.."XlAnD:Add:Rd:Manager:video_note"..k..GroupId,v:match('video_note@(.*)') )
end
end
end
end
...
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(TheXlAnD..'XlAnD:Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(TheXlAnD..'XlAnD:Num:Add:Bot'),"md",true)  
end
...
{
{text = '𝖲𝗈𝗎𝗋𝖼𝖾 XlAnD', url = 't.me/TeAm_XlAnD'},
},
}
}
if not msg.ControllerBot then
...
Redis:set(TheXlAnD.."XlAnD:Status:Id"..msg_chat_id,true) ;Redis:set(TheXlAnD.."XlAnD:Status:Reply"..msg_chat_id,true) ;Redis:set(TheXlAnD.."XlAnD:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(TheXlAnD.."XlAnD:Status:BanId"..msg_chat_id,true) ;Redis:set(TheXlAnD.."XlAnD:Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(TheXlAnD.."XlAnD:BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(TheXlAnD.."XlAnD:ChekBotAdd",msg_chat_id) then
...
if not Redis:get(TheXlAnD.."XlAnD:Status:Id"..msg_chat_id) then
return false
end
local UserInfo = LuaTele.getUser(msg.sender.user_id)
...
{{text =news,url = "https://t.me/TeAm_XlAnD"}, },}}
...
if not Redis:sismember(TheXlAnD.."XlAnD:DevelopersQ:Groups",UserId_Info.id) then
...
if not Redis:sismember(TheXlAnD.."XlAnD:Developers:Groups",UserId_Info.id) then
...
if not Redis:sismember(TheXlAnD.."XlAnD:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
...
if not Redis:sismember(TheXlAnD.."XlAnD:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
...
if not Redis:sismember(TheXlAnD.."XlAnD:Originators:Group"..msg_chat_id,UserId_Info.id) then
...
if not Redis:sismember(TheXlAnD.."XlAnD:Managers:Group"..msg_chat_id,UserId_Info.id) then
...
if not Redis:sismember(TheXlAnD.."XlAnD:Addictive:Group"..msg_chat_id,UserId_Info.id) then
...
if not Redis:sismember(TheXlAnD.."XlAnD:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
...
if not Redis:sismember(TheXlAnD.."XlAnD:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
if not Redis:sismember(TheXlAnD.."XlAnD:Developers:Groups",Message_Reply.sender.user_id) then
...
if not Redis:sismember(TheXlAnD.."XlAnD:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
if not Redis:sismember(TheXlAnD.."XlAnD:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
if not Redis:sismember(TheXlAnD.."XlAnD:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
if not Redis:sismember(TheXlAnD.."XlAnD:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
if not Redis:sismember(TheXlAnD.."XlAnD:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
if not Redis:sismember(TheXlAnD.."XlAnD:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
if not Redis:sismember(TheXlAnD.."XlAnD:DevelopersQ:Groups",UserId) then
...
if not Redis:sismember(TheXlAnD.."XlAnD:Developers:Groups",UserId) then
...
if not Redis:sismember(TheXlAnD.."XlAnD:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
...
if not Redis:sismember(TheXlAnD.."XlAnD:TheBasics:Group"..msg_chat_id,UserId[2]) then
...
if not Redis:sismember(TheXlAnD.."XlAnD:Originators:Group"..msg_chat_id,UserId[2]) then
...
if not Redis:sismember(TheXlAnD.."XlAnD:Managers:Group"..msg_chat_id,UserId[2]) then
...
if not Redis:sismember(TheXlAnD.."XlAnD:Addictive:Group"..msg_chat_id,UserId[2]) then
...
if not Redis:sismember(TheXlAnD.."XlAnD:Distinguished:Group"..msg_chat_id,UserId[2]) then
...
if not msg.Originators and not Redis:get(TheXlAnD.."XlAnD:Status:SetId"..msg_chat_id) then
...
if Redis:sismember(TheXlAnD.."XlAnD:DevelopersQ:Groups",UserId) then
...
if Redis:sismember(TheXlAnD.."XlAnD:Developers:Groups",UserId) then
...
if Redis:sismember(TheXlAnD.."XlAnD:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
...
if Redis:sismember(TheXlAnD.."XlAnD:TheBasics:Group"..msg_chat_id,UserId[2]) then
...
if Redis:sismember(TheXlAnD.."XlAnD:Originators:Group"..msg_chat_id,UserId[2]) then
...
if Redis:sismember(TheXlAnD.."XlAnD:Managers:Group"..msg_chat_id,UserId[2]) then
...
if Redis:sismember(TheXlAnD.."XlAnD:Addictive:Group"..msg_chat_id,UserId[2]) then
...
if Redis:sismember(TheXlAnD.."XlAnD:Distinguished:Group"..msg_chat_id,UserId[2]) then
...
Redis:set(TheXlAnD.."XlAnD:Sasa:Jeka"..msg_chat_id,true) 
...
local list = Redis:smembers(TheXlAnD.."XlAnD1:List:Rd:Sudo"..msg.chat_id)
for k,v in pairs(list) do  
Redis:del(TheXlAnD.."XlAnD1:Add:Rd:Sudo:Text"..v..msg.chat_id) 
Redis:del(TheXlAnD.."XlAnD1:Add:Rd:Sudo:Text1"..v..msg.chat_id) 
Redis:del(TheXlAnD.."XlAnD1:Add:Rd:Sudo:Text2"..v..msg.chat_id) 
Redis:del(TheXlAnD.."XlAnD1:List:Rd:Sudo"..msg.chat_id)
end
...
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheXlAnD.."XlAnD1:Add:Rd:Sudo:Text"..test..msg.chat_id, text)  
end  
...
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheXlAnD.."XlAnD1:Add:Rd:Sudo:Text1"..test..msg.chat_id, text)  
end  
...
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheXlAnD.."XlAnD1:Add:Rd:Sudo:Text2"..test..msg.chat_id, text)  
end  
...
Redis:del(TheXlAnD.."XlAnD11:List:Rd:Sudo")
end
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف ردود المتعدده")
end
...
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheXlAnD.."XlAnD11:Add:Rd:Sudo:Text"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
...
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheXlAnD.."XlAnD11:Add:Rd:Sudo:Text1"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
...
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheXlAnD.."XlAnD11:Add:Rd:Sudo:Text2"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد")
return false  
end  
...
Redis:del(TheXlAnD.."XlAnD:allM"..msg.chat_id)
end
end
end
...
Redis:del(TheXlAnD.."XlAnD:Status:yt"..msg.chat_id)
...
Redis:set(TheXlAnD.."XlAnD:Status:yt"..msg.chat_id,true)
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم تفعيل اليوتيوب')
return false
end 
if text and text:match('^بحث (.*)$') and Redis:get(TheXlAnD.."XlAnD:Status:yt"..msg.chat_id) then
...
if TextMsg == 'ردود السورس' then
Redis:del(TheXlAnD.."XlAnD:Sasa:Jeka"..msg_chat_id) 
...
if Redis:sismember(TheXlAnD.."XlAnD:BanAll:Groups",UserId_Info.id) then
...
if not Redis:sismember(TheXlAnD.."XlAnD:BanAll:Groups",UserId_Info.id) then
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/TeAm_XlAnD'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n ᥀︙ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
local UserId_Info = LuaTele.searchPublicChat(UserName)
if not UserId_Info.id then
...
if Redis:sismember(TheXlAnD.."XlAnD:ktmAll:Groups",UserId_Info.id) then
...
if not Redis:sismember(TheXlAnD.."XlAnD:ktmAll:Groups",UserId_Info.id) then
...
if not msg.Originators and not Redis:get(TheXlAnD.."XlAnD:Status:BanId"..msg_chat_id) then
...
if Redis:sismember(TheXlAnD.."XlAnD:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if not Redis:sismember(TheXlAnD.."XlAnD:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
...
if Redis:sismember(TheXlAnD.."XlAnD:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if not Redis:sismember(TheXlAnD.."XlAnD:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
...
if Redis:sismember(TheXlAnD.."XlAnD:BanAll:Groups",Message_Reply.sender.user_id) then
...
if not Redis:sismember(TheXlAnD.."XlAnD:BanAll:Groups",Message_Reply.sender.user_id) then
...
if Redis:sismember(TheXlAnD.."XlAnD:ktmAll:Groups",Message_Reply.sender.user_id) then
...
if not Redis:sismember(TheXlAnD.."XlAnD:ktmAll:Groups",Message_Reply.sender.user_id) then
...
if Redis:sismember(TheXlAnD.."XlAnD:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
if not Redis:sismember(TheXlAnD.."XlAnD:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
if Redis:sismember(TheXlAnD.."XlAnD:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
if not Redis:sismember(TheXlAnD.."XlAnD:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
if Redis:sismember(TheXlAnD.."XlAnD:BanAll:Groups",UserId) then
...
if not Redis:sismember(TheXlAnD.."XlAnD:BanAll:Groups",UserId) then
...
if Redis:sismember(TheXlAnD.."XlAnD:BanGroup:Group"..msg_chat_id,UserId) then
...
if not Redis:sismember(TheXlAnD.."XlAnD:BanGroup:Group"..msg_chat_id,UserId) then
...
if Redis:sismember(TheXlAnD.."XlAnD:SilentGroup:Group"..msg_chat_id,UserId) then
...
if not Redis:sismember(TheXlAnD.."XlAnD:SilentGroup:Group"..msg_chat_id,UserId) then
...
if not Redis:get(TheXlAnD.."XlAnD:Status:KickMe"..msg_chat_id) then
...
if not msg.ControllerBot and not Redis:set(TheXlAnD.."XlAnD:LeftBot") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = Redis:get(TheXlAnD.."XlAnD:Group:Link"..msg_chat_id) 
if GetLink then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
...
if not Redis:get(TheXlAnD.."XlAnD:Status:Welcome"..msg_chat_id) then
...
Redis:srem(TheXlAnD.."XlAnD:List:Filter"..msg_chat_id,v)  
end  
...
Redis:del(TheXlAnD.."XlAnD:Command:List:Group"..msg_chat_id)
end
...
data = {
{
{text = '- قناة السورس', url = 't.me/TeAm_XlAnD'}, 
},
}
}
...
Redis:del(TheXlAnD..'XlAnD:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(TheXlAnD..'XlAnD:Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
...
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عدد رسائلك هنا *~ '..(Redis:get(TheXlAnD..'XlAnD:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عدد التعديلات هنا *~ '..(Redis:get(TheXlAnD..'XlAnD:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
...
local list = Redis:smembers(TheXlAnD.."XlAnD:List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(TheXlAnD.."XlAnD:Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(TheXlAnD.."XlAnD:Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(TheXlAnD.."XlAnD:Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(TheXlAnD.."XlAnD:Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(TheXlAnD.."XlAnD:Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(TheXlAnD.."XlAnD:Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(TheXlAnD.."XlAnD:Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(TheXlAnD.."XlAnD:Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(TheXlAnD.."XlAnD:Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(TheXlAnD.."XlAnD:List:Manager"..msg_chat_id)
end
...
for k,v in pairs(list) do
if Redis:get(TheXlAnD.."XlAnD:Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(TheXlAnD.."XlAnD:Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(TheXlAnD.."XlAnD:Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(TheXlAnD.."XlAnD:Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(TheXlAnD.."XlAnD:Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(TheXlAnD.."XlAnD:Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(TheXlAnD.."XlAnD:Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف ⌔"
elseif Redis:get(TheXlAnD.."XlAnD:Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(TheXlAnD.."XlAnD:Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:del(TheXlAnD.."XlAnD:List:Rd:Sudo")
end
...
local UserId_Info = LuaTele.searchPublicChat("XCGCC")
...
keyboardd.inline_keyboard = {
{
{text = '❲ 𝖼𝗈𝖽𝖾𝗋 ❳', url = "https://t.me/XCGCC"}
},
{
{text = '❲ 𝖲𝗈𝗎𝗋𝖼𝖾 XlAnD ❳', url = "https://t.me/TeAm_XlAnD"},
},
...
if not Redis:get(TheXlAnD.."XlAnD:Status:gamle"..msg_chat_id) then
return false
end
local ban = LuaTele.getUser(msg.sender.user_id)
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
if Redis:get(TheXlAnD.."XlAnD:Status:kool"..msg.chat_id) then
...
local T =[[
Welcome to Source : [XlAnD TEAM.](https://t.me/TeAm_XlAnD)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝖣𝖤𝖵𝖤𝖫𝖮𝖯𝖤𝖱 ', url = "https://t.me/XCGCC"},{text = '𝖲𝗈𝗎𝗋𝖼𝖾 XlAnD', url = "https://t.me/TeAm_XlAnD"}
},
{
{text = 'ُ𝖳𝖶𝖲 Abbas', url = "https://t.me/XCGCC"}
},
{
{text = 'XlAnD TEAM.', url = "https://t.me/TeAm_XlAnD"}
},
}
local msgg = msg_id/2097152/0.5
...
if not Redis:get(TheXlAnD.."XlAnD:Sasa:Jeka"..msg_chat_id) then
...
if text == (Redis:get(TheXlAnD.."XlAnD:Name:Bot") or "جوكر") then
local NamesBot = (Redis:get(TheXlAnD.."XlAnD:Name:Bot") or "جوكر")
local NameBots = {
"ها "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
x = x + 1
Redis:srem(TheXlAnD..'XlAnD:Num:User:Pv',v)
end
end
if x ~= 0 then
...
Redis:set(TheXlAnD.."XlAnD:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
...
local CmdStart = '*\n᥀︙أهلآ بك في بوت '..(Redis:get(TheXlAnD.."XlAnD:Name:Bot") or "جوكر")..
...
data = {
{
{text = '᥀ السورس .', url = 't.me/TeAm_XlAnD'},{text = '᥀ لتنصيب بوت .', url = 't.me/XCGCC'}, 
},
{
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(TheXlAnD.."XlAnD:Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
Redis:del(TheXlAnD.."XlAnD:PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if tonumber(listYt[1]) == tonumber(IdUser) then
Redis:srem(TheXlAnD.."XlAnD:SilentGroup:Group"..ChatId,listYt[2]) 
Redis:srem(TheXlAnD.."XlAnD:BanGroup:Group"..ChatId,listYt[2]) 
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:del(TheXlAnD.."XlAnD:Redis:Id:Group"..ChatId..""..IdUser) 
Redis:del(TheXlAnD.."XlAnD1:Set:Rd"..IdUser..":"..ChatId)
Redis:del(TheXlAnD.."XlAnD:Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(TheXlAnD.."XlAnD:Set:Rd"..IdUser..":"..ChatId)
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheXlAnD.."XlAnD:Redis:Id:Group"..ChatId..""..IdUser,true) 
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheXlAnD.."XlAnD1:Set:Rd"..IdUser..":"..ChatId, "true")
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheXlAnD.."XlAnD:Set:Manager:rd"..IdUser..":"..ChatId,"true")
LuaTele.editMessageText(ChatId,Msg_id,"᥀︙ارسل لي الرد الان", 'md', true)
end
end
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheXlAnD.."XlAnD:Set:Rd"..IdUser..":"..ChatId,true)
LuaTele.editMessageText(ChatId,Msg_id,"᥀︙ارسل لي الرد الان", 'md', true)
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."XlAnD:Sasa:Jeka"..ChatId) 
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TheXlAnD.."XlAnD:TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
