...
Redis:set(TheXlAnD.."XlAnD:Status:gamle"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"*✦┇تم تفعيل ردود السورس *").unLock,"md",true) end
...
if TextMsg == 'ردود السورس' then
Redis:del(TheXlAnD.."XlAnD:Status:gamle"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"*✦┇تم تعطيل ردود السورس *").unLock,"md",true) end
if TextMsg == 'نزلني' then
