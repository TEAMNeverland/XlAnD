...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ Source Channel ›', url = "https://t.me/KKSII"}},{{text = '‹ Developer', url = "https://t.me/B333BB"},{text = 'TwS XlAnD ', url = "https://t.me/XCGCC"}},{{text = '‹ Exp Source ›', url = "https://t.me/KKSlI"}}}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo=https://t.me/KKSII&caption=".. URL.escape(tt).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) end
