...
Status = 0
DevelopersAS = Redis:sismember(TheXlAnD.."Raumo:DevelopersAS:Groups",UserId) 
DevelopersQ = Redis:sismember(TheXlAnD.."Raumo:DevelopersQ:Groups",UserId) 
...
Developers = Redis:sismember(TheXlAnD.."Raumo:Developers:Groups",UserId) 
DevelopersAS = Redis:sismember(TheXlAnD.."Raumo:DevelopersAS:Groups",UserId) 
DevelopersQ = Redis:sismember(TheXlAnD.."Raumo:DevelopersQ:Groups",UserId) 
TheBasics = Redis:sismember(TheXlAnD.."Raumo:TheBasics:Group"..ChatId,UserId)
TheBasicsQ = Redis:sismember(TheXlAnD.."Raumo:TheBasicsQ:Group"..ChatId,UserId) 
TheBas = Redis:sismember(TheXlAnD.."Raumo:TheBas:Group"..ChatId,UserId) 
Originators = Redis:sismember(TheXlAnD.."Raumo:Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(TheXlAnD.."Raumo:Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(TheXlAnD.."Raumo:Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(TheXlAnD.."Raumo:Distinguished:Group"..ChatId,UserId)
Cleaner = Redis:sismember(TheXlAnD.."Raumo:Cleaner:Group"..ChatId,UserId)
StatusMember = LuaTele.getChatMember(ChatId,UserId).status.luatele
if UserId == 1391769117 then Status = 'مبࢪمج السوࢪس' elseif UserId == 2126070107 then Status = 'Telegram Developer' elseif UserId == Sudo_Id then Status = 'المطور الاساسي' elseif UserId == TheXlAnD then Status = 'البوت' elseif DevelopersAS then Status = 'المطور الاساسي' elseif DevelopersQ then Status = 'المطور الاساسي²' elseif Developers then Status = Redis:get(TheXlAnD.."Raumo:Developer:Bot:Reply"..ChatId) or 'المطور' elseif TheBas then Status = Redis:get(TheXlAnD.."Raumo:TheBas:Group:Reply"..ChatId) or 'المالك' elseif TheBasicsQ then Status = Redis:get(TheXlAnD.."Raumo:PresidentQ:Group:Reply"..ChatId) or 'المالك' elseif TheBasics then Status = Redis:get(TheXlAnD.."Raumo:President:Group:Reply"..ChatId) or 'المنشئ الاساسي' elseif Originators then Status = Redis:get(TheXlAnD.."Raumo:Constructor:Group:Reply"..ChatId) or 'المنشئ' elseif Managers then Status = Redis:get(TheXlAnD.."Raumo:Manager:Group:Reply"..ChatId) or 'المدير' elseif Addictive then Status = Redis:get(TheXlAnD.."Raumo:Admin:Group:Reply"..ChatId) or 'الادمن' elseif StatusMember == "chatMemberStatusCreator" then Status = 'مالك المجموعة' elseif StatusMember == "chatMemberStatusAdministrator" then Status = 'ادمن المجموعة' elseif Distinguished then Status = Redis:get(TheXlAnD.."Raumo:Vip:Group:Reply"..ChatId) or 'المميز' elseif Cleaner then Status = Redis:get(TheXlAnD.."Raumo:Cle:Group:Reply"..ChatId) or 'المنظف' else Status = Redis:get(TheXlAnD.."Raumo:Mempar:Group:Reply"..ChatId) or 'العضو' end return Status end 
...
if Redis:get(TheXlAnD.."Raumo:lockpin"..ChatId) then lock_pin = "✓" else lock_pin = "✗" end
if Redis:get(TheXlAnD.."Raumo:Lock:tagservr"..ChatId) then lock_tagservr = "✓" else lock_tagservr = "✗" end
if Redis:get(TheXlAnD.."Raumo:Lock:text"..ChatId) then lock_text = "✓" else lock_text = "✗ " end
if Redis:get(TheXlAnD.."Raumo:Lock:AddMempar"..ChatId) == "kick" then lock_add = "✓" else lock_add = "✗ " end    
if Redis:get(TheXlAnD.."Raumo:Lock:Join"..ChatId) == "kick" then lock_join = "✓" else lock_join = "✗ " end    
if Redis:get(TheXlAnD.."Raumo:Lock:edit"..ChatId) then lock_edit = "✓" else lock_edit = "✗ " end
if Redis:get(TheXlAnD.."Raumo:Chek:Welcome"..ChatId) then welcome = "✓" else welcome = "✗ " end
if Redis:hget(TheXlAnD.."Raumo:Spam:Group:User"..ChatId, "Spam:User") == "kick" then flood = "بالطرد "     
elseif Redis:hget(TheXlAnD.."Raumo:Spam:Group:User"..ChatId,"Spam:User") == "keed" then flood = "بالتقيد "     
elseif Redis:hget(TheXlAnD.."Raumo:Spam:Group:User"..ChatId,"Spam:User") == "mute" then flood = "بالكتم "           
elseif Redis:hget(TheXlAnD.."Raumo:Spam:Group:User"..ChatId,"Spam:User") == "del" then flood = "✓" else flood = "✗ " end
if Redis:get(TheXlAnD.."Raumo:Lock:Photo"..ChatId) == "del" then lock_photo = "✓" 
elseif Redis:get(TheXlAnD.."Raumo:Lock:Photo"..ChatId) == "ked" then lock_photo = "بالتقيد "   
elseif Redis:get(TheXlAnD.."Raumo:Lock:Photo"..ChatId) == "ktm" then lock_photo = "بالكتم "    
elseif Redis:get(TheXlAnD.."Raumo:Lock:Photo"..ChatId) == "kick" then lock_photo = "بالطرد " else lock_photo = "✗ " end    
if Redis:get(TheXlAnD.."Raumo:Lock:Contact"..ChatId) == "del" then lock_phon = "✓" 
elseif Redis:get(TheXlAnD.."Raumo:Lock:Contact"..ChatId) == "ked" then lock_phon = "بالتقيد "    
elseif Redis:get(TheXlAnD.."Raumo:Lock:Contact"..ChatId) == "ktm" then lock_phon = "بالكتم "    
elseif Redis:get(TheXlAnD.."Raumo:Lock:Contact"..ChatId) == "kick" then lock_phon = "بالطرد " else lock_phon = "✗ " end    
if Redis:get(TheXlAnD.."Raumo:Lock:Link"..ChatId) == "del" then lock_links = "✓"
elseif Redis:get(TheXlAnD.."Raumo:Lock:Link"..ChatId) == "ked" then lock_links = "بالتقيد "    
elseif Redis:get(TheXlAnD.."Raumo:Lock:Link"..ChatId) == "ktm" then lock_links = "بالكتم "    
elseif Redis:get(TheXlAnD.."Raumo:Lock:Link"..ChatId) == "kick" then lock_links = "بالطرد " else lock_links = "✗ " end
if Redis:get(TheXlAnD.."Raumo:Lock:Cmd"..ChatId) == "del" then lock_cmds = "✓"
elseif Redis:get(TheXlAnD.."Raumo:Lock:Cmd"..ChatId) == "ked" then lock_cmds = "بالتقيد "    
elseif Redis:get(TheXlAnD.."Raumo:Lock:Cmd"..ChatId) == "ktm" then lock_cmds = "بالكتم "   
elseif Redis:get(TheXlAnD.."Raumo:Lock:Cmd"..ChatId) == "kick" then lock_cmds = "بالطرد " else lock_cmds = "✗ " end
if Redis:get(TheXlAnD.."Raumo:Lock:User:Name"..ChatId) == "del" then lock_user = "✓"
elseif Redis:get(TheXlAnD.."Raumo:Lock:User:Name"..ChatId) == "ked" then lock_user = "بالتقيد "    
elseif Redis:get(TheXlAnD.."Raumo:Lock:User:Name"..ChatId) == "ktm" then lock_user = "بالكتم "    
elseif Redis:get(TheXlAnD.."Raumo:Lock:User:Name"..ChatId) == "kick" then lock_user = "بالطرد " else lock_user = "✗ " end
if Redis:get(TheXlAnD.."Raumo:Lock:hashtak"..ChatId) == "del" then lock_hash = "✓"
elseif Redis:get(TheXlAnD.."Raumo:Lock:hashtak"..ChatId) == "ked" then lock_hash = "بالتقيد "    
elseif Redis:get(TheXlAnD.."Raumo:Lock:hashtak"..ChatId) == "ktm" then lock_hash = "بالكتم "    
elseif Redis:get(TheXlAnD.."Raumo:Lock:hashtak"..ChatId) == "kick" then lock_hash = "بالطرد " else lock_hash = "✗ " end
if Redis:get(TheXlAnD.."Raumo:Lock:vico"..ChatId) == "del" then lock_muse = "✓"
elseif Redis:get(TheXlAnD.."Raumo:Lock:vico"..ChatId) == "ked" then lock_muse = "بالتقيد "    
elseif Redis:get(TheXlAnD.."Raumo:Lock:vico"..ChatId) == "ktm" then lock_muse = "بالكتم "    
elseif Redis:get(TheXlAnD.."Raumo:Lock:vico"..ChatId) == "kick" then lock_muse = "بالطرد " else lock_muse = "✗ " end 
if Redis:get(TheXlAnD.."Raumo:Lock:Video"..ChatId) == "del" then lock_ved = "✓"
elseif Redis:get(TheXlAnD.."Raumo:Lock:Video"..ChatId) == "ked" then lock_ved = "بالتقيد "    
elseif Redis:get(TheXlAnD.."Raumo:Lock:Video"..ChatId) == "ktm" then lock_ved = "بالكتم "    
elseif Redis:get(TheXlAnD.."Raumo:Lock:Video"..ChatId) == "kick" then lock_ved = "بالطرد " else lock_ved = "✗ " end
if Redis:get(TheXlAnD.."Raumo:Lock:Animation"..ChatId) == "del" then lock_gif = "✓"
elseif Redis:get(TheXlAnD.."Raumo:Lock:Animation"..ChatId) == "ked" then lock_gif = "بالتقيد "    
elseif Redis:get(TheXlAnD.."Raumo:Lock:Animation"..ChatId) == "ktm" then lock_gif = "بالكتم "    
elseif Redis:get(TheXlAnD.."Raumo:Lock:Animation"..ChatId) == "kick" then lock_gif = "بالطرد " else lock_gif = "✗ " end
if Redis:get(TheXlAnD.."Raumo:Lock:Sticker"..ChatId) == "del" then lock_ste = "✓"
elseif Redis:get(TheXlAnD.."Raumo:Lock:Sticker"..ChatId) == "ked" then lock_ste = "بالتقيد "    
elseif Redis:get(TheXlAnD.."Raumo:Lock:Sticker"..ChatId) == "ktm" then lock_ste = "بالكتم "    
elseif Redis:get(TheXlAnD.."Raumo:Lock:Sticker"..ChatId) == "kick" then lock_ste = "بالطرد " else lock_ste = "✗ " end
if Redis:get(TheXlAnD.."Raumo:Lock:geam"..ChatId) == "del" then lock_geam = "✓"
elseif Redis:get(TheXlAnD.."Raumo:Lock:geam"..ChatId) == "ked" then lock_geam = "بالتقيد "    
elseif Redis:get(TheXlAnD.."Raumo:Lock:geam"..ChatId) == "ktm" then lock_geam = "بالكتم "    
elseif Redis:get(TheXlAnD.."Raumo:Lock:geam"..ChatId) == "kick" then lock_geam = "بالطرد " else lock_geam = "✗ " end    
if Redis:get(TheXlAnD.."Raumo:Lock:vico"..ChatId) == "del" then lock_vico = "✓"
elseif Redis:get(TheXlAnD.."Raumo:Lock:vico"..ChatId) == "ked" then lock_vico = "بالتقيد "    
elseif Redis:get(TheXlAnD.."Raumo:Lock:vico"..ChatId) == "ktm" then lock_vico = "بالكتم "    
elseif Redis:get(TheXlAnD.."Raumo:Lock:vico"..ChatId) == "kick" then lock_vico = "بالطرد " else lock_vico = "✗ " end    
if Redis:get(TheXlAnD.."Raumo:Lock:Keyboard"..ChatId) == "del" then lock_inlin = "✓"
elseif Redis:get(TheXlAnD.."Raumo:Lock:Keyboard"..ChatId) == "ked" then lock_inlin = "بالتقيد "
elseif Redis:get(TheXlAnD.."Raumo:Lock:Keyboard"..ChatId) == "ktm" then lock_inlin = "بالكتم "    
elseif Redis:get(TheXlAnD.."Raumo:Lock:Keyboard"..ChatId) == "kick" then lock_inlin = "بالطرد " else lock_inlin = "✗ " end
if Redis:get(TheXlAnD.."Raumo:Lock:forward"..ChatId) == "del" then lock_fwd = "✓"
elseif Redis:get(TheXlAnD.."Raumo:Lock:forward"..ChatId) == "ked" then lock_fwd = "بالتقيد "    
elseif Redis:get(TheXlAnD.."Raumo:Lock:forward"..ChatId) == "ktm" then lock_fwd = "بالكتم "    
elseif Redis:get(TheXlAnD.."Raumo:Lock:forward"..ChatId) == "kick" then lock_fwd = "بالطرد " else lock_fwd = "✗ " end    
if Redis:get(TheXlAnD.."Raumo:Lock:Document"..ChatId) == "del" then lock_file = "✓"
elseif Redis:get(TheXlAnD.."Raumo:Lock:Document"..ChatId) == "ked" then lock_file = "بالتقيد "    
elseif Redis:get(TheXlAnD.."Raumo:Lock:Document"..ChatId) == "ktm" then lock_file = "بالكتم "    
elseif Redis:get(TheXlAnD.."Raumo:Lock:Document"..ChatId) == "kick" then lock_file = "بالطرد " else lock_file = "✗ " end    
if Redis:get(TheXlAnD.."Raumo:Lock:Unsupported"..ChatId) == "del" then lock_self = "✓"
elseif Redis:get(TheXlAnD.."Raumo:Lock:Unsupported"..ChatId) == "ked" then lock_self = "بالتقيد "    
elseif Redis:get(TheXlAnD.."Raumo:Lock:Unsupported"..ChatId) == "ktm" then lock_self = "بالكتم "    
elseif Redis:get(TheXlAnD.."Raumo:Lock:Unsupported"..ChatId) == "kick" then lock_self = "بالطرد " else lock_self = "✗ " end
if Redis:get(TheXlAnD.."Raumo:Lock:Bot:kick"..ChatId) == "del" then lock_bots = "✓"
elseif Redis:get(TheXlAnD.."Raumo:Lock:Bot:kick"..ChatId) == "ked" then lock_bots = "بالتقيد "   
elseif Redis:get(TheXlAnD.."Raumo:Lock:Bot:kick"..ChatId) == "kick" then lock_bots = "بالطرد " else lock_bots = "✗ " end
if Redis:get(TheXlAnD.."Raumo:Lock:Markdaun"..ChatId) == "del" then lock_mark = "✓"
elseif Redis:get(TheXlAnD.."Raumo:Lock:Markdaun"..ChatId) == "ked" then lock_mark = "بالتقيد "    
elseif Redis:get(TheXlAnD.."Raumo:Lock:Markdaun"..ChatId) == "ktm" then lock_mark = "بالكتم "    
elseif Redis:get(TheXlAnD.."Raumo:Lock:Markdaun"..ChatId) == "kick" then lock_mark = "بالطرد " else lock_mark = "✗ " end
if Redis:get(TheXlAnD.."Raumo:Lock:Spam"..ChatId) == "del" then lock_spam = "✓"
elseif Redis:get(TheXlAnD.."Raumo:Lock:Spam"..ChatId) == "ked" then lock_spam = "بالتقيد "    
elseif Redis:get(TheXlAnD.."Raumo:Lock:Spam"..ChatId) == "ktm" then lock_spam = "بالكتم "    
elseif Redis:get(TheXlAnD.."Raumo:Lock:Spam"..ChatId) == "kick" then lock_spam = "بالطرد " else lock_spam = "✗ " end        
...
return{ BanAll = Redis:sismember(TheXlAnD.."Raumo:BanAll:Groups",UserId) , ktmAll = Redis:sismember(TheXlAnD.."Raumo:ktmAll:Groups",UserId) , BanGroup = Redis:sismember(TheXlAnD.."Raumo:BanGroup:Group"..ChatId,UserId) , SilentGroup = Redis:sismember(TheXlAnD.."Raumo:SilentGroup:Group"..ChatId,UserId) } end
...
local Channel = Redis:get(TheXlAnD..'Raumo:Channel:Join')
if Channel then
...
elseif Redis:sismember(TheXlAnD.."Raumo:DevelopersAS:Groups",msg.sender.user_id) == true then msg.The_Controller = 100 msg.Name_Controller = 'المطور الاساسي'
elseif Redis:sismember(TheXlAnD.."Raumo:DevelopersQ:Groups",msg.sender.user_id) == true then msg.The_Controller = 2 msg.Name_Controller = 'المطور الاساسي²'
elseif Redis:sismember(TheXlAnD.."Raumo:Developers:Groups",msg.sender.user_id) == true then msg.The_Controller = 3 msg.Name_Controller = Redis:get(TheXlAnD.."Raumo:Developer:Bot:Reply"..msg.chat_id) or 'المطور'
elseif Redis:sismember(TheXlAnD.."Raumo:TheBas:Group"..msg.chat_id,msg.sender.user_id) == true then msg.The_Controller = 99 msg.Name_Controller = Redis:get(TheXlAnD.."Raumo:TheBas:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(TheXlAnD.."Raumo:TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then msg.The_Controller = 44 msg.Name_Controller = Redis:get(TheXlAnD.."Raumo:PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(TheXlAnD.."Raumo:TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then msg.The_Controller = 4 msg.Name_Controller = Redis:get(TheXlAnD.."Raumo:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(TheXlAnD.."Raumo:Originators:Group"..msg.chat_id,msg.sender.user_id) == true then msg.The_Controller = 5 msg.Name_Controller = Redis:get(TheXlAnD.."Raumo:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ'
elseif Redis:sismember(TheXlAnD.."Raumo:Managers:Group"..msg.chat_id,msg.sender.user_id) == true then msg.The_Controller = 6 msg.Name_Controller = Redis:get(TheXlAnD.."Raumo:Manager:Group:Reply"..msg.chat_id) or 'المدير'
elseif Redis:sismember(TheXlAnD.."Raumo:Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then msg.The_Controller = 7 msg.Name_Controller = Redis:get(TheXlAnD.."Raumo:Admin:Group:Reply"..msg.chat_id) or 'الادمن'
elseif Redis:sismember(TheXlAnD.."Raumo:Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then msg.The_Controller = 8 msg.Name_Controller = Redis:get(TheXlAnD.."Raumo:Vip:Group:Reply"..msg.chat_id) or 'المميز'
elseif Redis:sismember(TheXlAnD.."Raumo:Cleaner:Group"..msg.chat_id,msg.sender.user_id) == true then msg.The_Controller = 88 msg.Name_Controller = Redis:get(TheXlAnD.."Raumo:Cle:Group:Reply"..msg.chat_id) or 'المنظف'
elseif tonumber(msg.sender.user_id) == tonumber(TheXlAnD) then msg.The_Controller = 9 else msg.The_Controller = 10 msg.Name_Controller = Redis:get(TheXlAnD.."Raumo:Mempar:Group:Reply"..msg.chat_id) or 'العضو' end  
...
if Redis:get(TheXlAnD.."Raumo:Lock:Fshar"..msg_chat_id) and not msg.Addictive then
...
if Redis:get(TheXlAnD.."Raumo:Lock:Taf"..msg_chat_id) and not msg.Addictive then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
...
if Redis:get(TheXlAnD.."Raumo:Lock:Kfr"..msg_chat_id) and not msg.Addictive then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
...
if Redis:get(TheXlAnD.."Raumo:Lock:Farsi"..msg_chat_id) and not msg.Addictive then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"✦┇ممنوع التكلم باللغه الفارسيه").ReplyAlsh,"md",true)
return false end end
if Redis:get(TheXlAnD.."Raumo:Lock:text"..msg_chat_id) and not msg.Addictive then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(TheXlAnD.."Raumo:Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(TheXlAnD.."Raumo:Welcome:Group"..msg_chat_id)
if Welcome then 
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(TheXlAnD.."Raumo:Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(TheXlAnD) then return false end
local floods = Redis:hget(TheXlAnD.."Raumo:Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(TheXlAnD.."Raumo:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(TheXlAnD.."Raumo:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(TheXlAnD.."Raumo:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(TheXlAnD.."Raumo:Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(TheXlAnD.."Raumo:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
Redis:setex(TheXlAnD.."Raumo:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(TheXlAnD.."Raumo:Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(TheXlAnD.."Raumo:Spam:Group:User"..msg_chat_id,"Num:Spam")  end end 
if text and not msg.Distinguished then
local _nl, ctrl_ = string.gsub(text, "%c", "")  
local _nl, real_ = string.gsub(text, "%d", "")   
sens = 400  
if Redis:get(TheXlAnD.."Raumo:Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TheXlAnD.."Raumo:Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TheXlAnD.."Raumo:Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TheXlAnD.."Raumo:Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(TheXlAnD.."Raumo:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id}) end end
if msg.forward_info and not msg.TheBasics then -- التوجيه
local Fwd_Group = Redis:get(TheXlAnD.."Raumo:Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(TheXlAnD.."Raumo:Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(TheXlAnD.."Raumo:Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(TheXlAnD.."Raumo:Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(TheXlAnD.."Raumo:lockpin"..msg_chat_id)
...
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(TheXlAnD.."Raumo:Lock:Join"..msg.chat_id) == "kick" then
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false end end
if msg.content.luatele == "messageChatAddMembers" then -- اضافه اشخاص
print('This is Add Membeers ')
Redis:incr(TheXlAnD.."Raumo:Raumo:Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(TheXlAnD.."Raumo:Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(TheXlAnD.."Raumo:Lock:Bot:kick"..msg_chat_id)
for k,v in pairs(msg.content.member_user_ids) do
local Info_User = LuaTele.getUser(v) 
print(v)
if v == tonumber(TheXlAnD) then
local N = (Redis:get(TheXlAnD.."Raumo:Name:Bot") or "اكسلاند")
...
Redis:set(TheXlAnD.."Raumo:Who:Added:Me"..msg_chat_id..":"..v,msg.sender.user_id)
...
Redis:incr(TheXlAnD.."Raumo:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Videonote_Group = Redis:get(TheXlAnD.."Raumo:Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(TheXlAnD.."Raumo:Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(TheXlAnD.."Raumo:Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(TheXlAnD.."Raumo:Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(TheXlAnD.."Raumo:Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(TheXlAnD.."Raumo:Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(TheXlAnD.."Raumo:Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(TheXlAnD.."Raumo:Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(TheXlAnD.."Raumo:Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(TheXlAnD.."Raumo:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
local ChatPhoto = LuaTele.setChatPhoto(msg_chat_id,msg.content.photo.sizes[2].photo.remote.id)
if (ChatPhoto.luatele == "error") then
Redis:del(TheXlAnD.."Raumo:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(TheXlAnD.."Raumo:Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(TheXlAnD.."Raumo:Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(TheXlAnD.."Raumo:Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(TheXlAnD.."Raumo:Lock:Cmd"..msg_chat_id)
...
if (Redis:get(TheXlAnD..'Raumo:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then Filters = 'صوره'
Redis:sadd(TheXlAnD.."Raumo:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(TheXlAnD.."Raumo:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then Filters = 'متحركه'
Redis:sadd(TheXlAnD.."Raumo:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(TheXlAnD.."Raumo:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then Filters = 'ملصق'
Redis:sadd(TheXlAnD.."Raumo:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(TheXlAnD.."Raumo:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(TheXlAnD.."Raumo:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(TheXlAnD.."Raumo:List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'رسالة' end
Redis:set(TheXlAnD..'Raumo:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇ارسل تحذير ( "..Filters.." ) عند ارساله","md",true) end end
if text and (Redis:get(TheXlAnD..'Raumo:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(TheXlAnD.."Raumo:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(TheXlAnD.."Raumo:Filter:Group:"..Text_Filter..msg_chat_id,text)  end  
Redis:del(TheXlAnD.."Raumo:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(TheXlAnD..'Raumo:FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇تم اضافة رد التحذير","md",true)  end
if (Redis:get(TheXlAnD..'Raumo:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then Filters = 'الصوره'
Redis:srem(TheXlAnD.."Raumo:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(TheXlAnD.."Raumo:Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then Filters = 'المتحركه'
Redis:srem(TheXlAnD.."Raumo:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(TheXlAnD.."Raumo:Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then Filters = 'الملصق'
Redis:srem(TheXlAnD.."Raumo:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(TheXlAnD.."Raumo:Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(TheXlAnD.."Raumo:List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(TheXlAnD.."Raumo:Filter:Group:"..text..msg_chat_id)  
Filters = 'الرسالة' end
Redis:del(TheXlAnD..'Raumo:FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(TheXlAnD.."Raumo:Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(TheXlAnD.."Raumo:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(TheXlAnD.."Raumo:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(TheXlAnD.."Raumo:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(TheXlAnD.."Raumo:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(TheXlAnD.."Raumo:Command:List:Group"..msg_chat_id,text)
...
Redis:del(TheXlAnD.."Raumo:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false end
if text and Redis:get(TheXlAnD.."Raumo:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(TheXlAnD.."Raumo:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(TheXlAnD.."Raumo:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(TheXlAnD.."Raumo:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"✦┇ارسل الامر الجديد","md",true)  end
if text and Redis:get(TheXlAnD.."Raumo:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(TheXlAnD.."Raumo:Command:Reids:Group:New"..msg_chat_id)
Redis:set(TheXlAnD.."Raumo:Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(TheXlAnD.."Raumo:Command:List:Group"..msg_chat_id,text)
Redis:del(TheXlAnD.."Raumo:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"✦┇تم حفظ الامر باسم ↫ ‹ "..text..' ›',"md",true) end
if Redis:get(TheXlAnD.."Raumo:Set:Link"..msg_chat_id..""..msg.sender.user_id) then
...
Redis:set(TheXlAnD.."Raumo:Group:Link"..msg_chat_id,LinkGroup)
Redis:del(TheXlAnD.."Raumo:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(TheXlAnD.."Raumo:Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"✦┇تم حفظ ترحيب المجموعة","md",true) end
if Redis:get(TheXlAnD.."Raumo:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
Redis:set(TheXlAnD.."Raumo:Group:Rules" .. msg_chat_id,text) 
Redis:del(TheXlAnD.."Raumo:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"✦┇تم حفظ قوانين المجموعة","md",true)  end  
if Redis:get(TheXlAnD.."Raumo:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
LuaTele.setChatDescription(msg_chat_id,text) 
Redis:del(TheXlAnD.."Raumo:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"✦┇تم حفظ وصف المجموعة","md",true)  end  
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(TheXlAnD.."Raumo:Text:Manager"..msg.sender.user_id..":"..msg_chat_id.."")
if Redis:get(TheXlAnD.."Raumo:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
local reply_markup = LuaTele.replyMarkup{type = 'inline',
data = {{{text = 'حذف الرد ↫ ‹ '..test..' ›', data = msg.sender.user_id..'/closerD'},},}}
Redis:del(TheXlAnD.."Raumo:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(TheXlAnD.."Raumo:Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  end   
if msg.content.voice_note then  
Redis:set(TheXlAnD.."Raumo:Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheXlAnD.."Raumo:Add:Rd:Manager:Text"..test..msg_chat_id, text)  end  
if msg.content.audio then
Redis:set(TheXlAnD.."Raumo:Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  end
if msg.content.document then
Redis:set(TheXlAnD.."Raumo:Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  end
if msg.content.animation then
Redis:set(TheXlAnD.."Raumo:Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  end
if msg.content.video_note then
Redis:set(TheXlAnD.."Raumo:Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  end
if msg.content.video then
Redis:set(TheXlAnD.."Raumo:Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  end
...
print(idPhoto)
Redis:set(TheXlAnD.."Raumo:Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  end
return LuaTele.sendText(msg_chat_id,msg_id,"✦┇تم حفظ رد المدير الجديد","md",false ,false, false, false, reply_markup) end end
if text and text:match("^(.*)$") then
if Redis:get(TheXlAnD.."Raumo:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
local reply_markup = LuaTele.replyMarkup{type = 'inline',
data = {{{text = '‹ الغاء ›', data = msg.sender.user_id..'/closerd'},},}}
Redis:set(TheXlAnD.."Raumo:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(TheXlAnD.."Raumo:Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(TheXlAnD.."Raumo:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(TheXlAnD.."Raumo:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(TheXlAnD.."Raumo:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(TheXlAnD.."Raumo:Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(TheXlAnD.."Raumo:Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(TheXlAnD.."Raumo:Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(TheXlAnD.."Raumo:Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(TheXlAnD.."Raumo:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(TheXlAnD.."Raumo:Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:sadd(TheXlAnD.."Raumo:List:Manager"..msg_chat_id.."", text)
...
if text and text:match("^(.*)$") then
if Redis:get(TheXlAnD.."Raumo:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(TheXlAnD.."Raumo:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(TheXlAnD.."Raumo:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(TheXlAnD.."Raumo:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(TheXlAnD.."Raumo:Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(TheXlAnD.."Raumo:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(TheXlAnD.."Raumo:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(TheXlAnD.."Raumo:List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,'✦┇الكلمة ↫ ‹ '..text..' › تم حذفها',"md",true)  
return false end end
if text and Redis:get(TheXlAnD.."Raumo:Status:ReplySudo"..msg_chat_id) then
local anemi = Redis:get(TheXlAnD.."Raumo:Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(TheXlAnD.."Raumo:Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(TheXlAnD.."Raumo:Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(TheXlAnD.."Raumo:Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(TheXlAnD.."Raumo:Add:Rd:Sudo:Photo"..text)
local video = Redis:get(TheXlAnD.."Raumo:Add:Rd:Sudo:Video"..text)
local document = Redis:get(TheXlAnD.."Raumo:Add:Rd:Sudo:File"..text)
local audio = Redis:get(TheXlAnD.."Raumo:Add:Rd:Sudo:Audio"..text)
local video_note = Redis:get(TheXlAnD.."Raumo:Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(TheXlAnD..'Raumo:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
if UserInfo.username then UserInfousername = '@'..UserInfo.username..'' else UserInfousername = 'لا يوجد' end
local NumMessageEdit = Redis:get(TheXlAnD..'Raumo:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
if text and Redis:get(TheXlAnD.."Raumo:Status:Reply"..msg_chat_id) then
local anemi = Redis:get(TheXlAnD.."Raumo:Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(TheXlAnD.."Raumo:Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(TheXlAnD.."Raumo:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(TheXlAnD.."Raumo:Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(TheXlAnD.."Raumo:Add:Rd:Manager:Photo"..text..msg_chat_id)
local video = Redis:get(TheXlAnD.."Raumo:Add:Rd:Manager:Video"..text..msg_chat_id)
local document = Redis:get(TheXlAnD.."Raumo:Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(TheXlAnD.."Raumo:Add:Rd:Manager:Audio"..text..msg_chat_id)
local video_note = Redis:get(TheXlAnD.."Raumo:Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(TheXlAnD..'Raumo:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
if audio then LuaTele.sendAudio(msg_chat_id, msg.id, audio, '', "md")  end end
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(TheXlAnD.."Raumo:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(TheXlAnD.."Raumo:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then Redis:del(TheXlAnD.."Raumo:Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then Redis:set(TheXlAnD.."Raumo:Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  end   
if msg.content.voice_note then Redis:set(TheXlAnD.."Raumo:Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  end   
if msg.content.animation then Redis:set(TheXlAnD.."Raumo:Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheXlAnD.."Raumo:Add:Rd:Sudo:Text"..test, text)  end  
if msg.content.audio then Redis:set(TheXlAnD.."Raumo:Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  end
if msg.content.document then Redis:set(TheXlAnD.."Raumo:Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  end
if msg.content.video then Redis:set(TheXlAnD.."Raumo:Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  end
if msg.content.video_note then Redis:set(TheXlAnD.."Raumo:Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  end
if msg.content.photo then
...
Redis:set(TheXlAnD.."Raumo:Add:Rd:Sudo:Photo"..test, idPhoto) end
LuaTele.sendText(msg_chat_id,msg_id,"✦┇تم حفظ رد للمطور \n✦┇ارسل ( "..test.." ) لرؤية الرد","md",true)  
return false end end
if text and text:match("^(.*)$") then
if Redis:get(TheXlAnD.."Raumo:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(TheXlAnD.."Raumo:Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(TheXlAnD.."Raumo:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(TheXlAnD.."Raumo:List:Rd:Sudo", text)
LuaTele.sendText(msg_chat_id,msg_id,[[
✦┇ارسل لي الرد سواء كان :
‹ ملف • ملصق • متحركه • صوره
...
if text and text:match("^(.*)$") then
if Redis:get(TheXlAnD.."Raumo:Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
Redis:del(TheXlAnD..'Raumo:'..v..text) end
Redis:del(TheXlAnD.."Raumo:Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(TheXlAnD.."Raumo:List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"✦┇تم حذف الرد من ردود المطور","md",true) end end
if Redis:get(TheXlAnD.."Raumo:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '‹ الغاء الامر ›' then   
Redis:del(TheXlAnD.."Raumo:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n✦┇تم الغاء الاذاعه للمجموعات","md",true)  end 
local list = Redis:smembers(TheXlAnD.."Raumo:ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(TheXlAnD.."Raumo:PinMsegees:"..v,msg.content.video_note.video.remote.id) end
...
Redis:set(TheXlAnD.."Raumo:PinMsegees:"..v,idPhoto) end
elseif msg.content.sticker then 
for k,v in pairs(list) do LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(TheXlAnD.."Raumo:PinMsegees:"..v,msg.content.sticker.sticker.remote.id) end
elseif msg.content.voice_note then 
for k,v in pairs(list) do LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(TheXlAnD.."Raumo:PinMsegees:"..v,msg.content.voice_note.voice.remote.id) end
elseif msg.content.video then 
for k,v in pairs(list) do LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(TheXlAnD.."Raumo:PinMsegees:"..v,msg.content.video.video.remote.id) end
elseif msg.content.animation then 
for k,v in pairs(list) do LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(TheXlAnD.."Raumo:PinMsegees:"..v,msg.content.animation.animation.remote.id) end
elseif msg.content.document then
for k,v in pairs(list) do LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(TheXlAnD.."Raumo:PinMsegees:"..v,msg.content.document.document.remote.id) end
elseif msg.content.audio then
for k,v in pairs(list) do LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(TheXlAnD.."Raumo:PinMsegees:"..v,msg.content.audio.audio.remote.id) end
elseif text then
for k,v in pairs(list) do LuaTele.sendText(v,0,text,"md",true)
Redis:set(TheXlAnD.."Raumo:PinMsegees:"..v,text) end end
LuaTele.sendText(msg_chat_id,msg_id,"✦┇تمت الاذاعه الى *- "..#list.." * مجموعة في البوت ","md",true)      
Redis:del(TheXlAnD.."Raumo:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return false end
------------------------------------------------------------------------------------------------------------
if Redis:get(TheXlAnD.."Raumo:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '‹ الغاء الامر ›' then   
Redis:del(TheXlAnD.."Raumo:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n✦┇تم الغاء الاذاعه خاص","md",true)  end 
local list = Redis:smembers(TheXlAnD..'Raumo:Num:User:Pv')  
if msg.content.video_note then
for k,v in pairs(list) do 
...
return false end
------------------------------------------------------------------------------------------------------------
if Redis:get(TheXlAnD.."Raumo:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '‹ الغاء الامر ›' then   
Redis:del(TheXlAnD.."Raumo:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n✦┇تم الغاء الاذاعه للمجموعات","md",true)  end 
local list = Redis:smembers(TheXlAnD.."Raumo:ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
...
return false end
------------------------------------------------------------------------------------------------------------
if Redis:get(TheXlAnD.."Raumo:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '‹ الغاء الامر ›' then   
Redis:del(TheXlAnD.."Raumo:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheXlAnD.."Raumo:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '‹ الغاء الامر ›' then   
Redis:del(TheXlAnD.."Raumo:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(TheXlAnD..'Raumo:GetOwner:OwnerTheXlAnD'..msg_chat_id..':'..msg.sender.user_id) then
Redis:set(TheXlAnD..'Raumo:Owner:OwnerTheXlAnD'..msg_chat_id,text)
Redis:del(TheXlAnD..'Raumo:GetOwner:OwnerTheXlAnD'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'✦┇تم حفظ كليشة المنشئ') end
if text and Redis:get(TheXlAnD..'Raumo:GetTexting:DevTheXlAnD'..msg_chat_id..':'..msg.sender.user_id) then
Redis:set(TheXlAnD..'Raumo:Texting:DevTheXlAnD',text)
Redis:del(TheXlAnD..'Raumo:GetTexting:DevTheXlAnD'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'✦┇تم حفظ كليشة المطور') end
if Redis:get(TheXlAnD.."Raumo:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' or text == '‹ الغاء الامر ›' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n✦┇تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(TheXlAnD.."Raumo:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false end 
Redis:del(TheXlAnD.."Raumo:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(TheXlAnD.."Raumo:Set:Id:Groups"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'✦┇تم تعين الايدي عام',"md",true)  end
if Redis:get(TheXlAnD.."Raumo:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' or text == '‹ الغاء الامر ›' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n✦┇تم الغاء امر تعين الايدي","md",true)  
Redis:del(TheXlAnD.."Raumo:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false end 
Redis:del(TheXlAnD.."Raumo:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(TheXlAnD.."Raumo:Set:Id:Group"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'✦┇تم تعين الايدي الجديد',"md",true)  end
-- Alsh
if Redis:get(TheXlAnD.."Raumo:Change:CH:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == '‹ الغاء الامر ›' then   
Redis:del(TheXlAnD.."Raumo:Change:CH:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n✦┇تم الغاء امر تغير اسم القناة","md",true)  end 
Redis:del(TheXlAnD.."Raumo:Change:CH:Bot"..msg.sender.user_id) 
Redis:set(TheXlAnD.."Raumo:CH:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "✦┇تم تغير اسم القتاة الى ↫ ❨ "..text.." ❩","md",true) end 
--
if Redis:get(TheXlAnD.."Raumo:Change:CHlink:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == '‹ الغاء الامر ›' then   
Redis:del(TheXlAnD.."Raumo:Change:CHlink:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n✦┇تم الغاء امر تغير كليشة الاشتراك","md",true)  end 
Redis:del(TheXlAnD.."Raumo:Change:CHlink:Bot"..msg.sender.user_id) 
Redis:set(TheXlAnD.."Raumo:CHlink:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "✦┇تم تغير الكليشة الى ↫ ⤈\n ❨ "..text.." ❩","md",true) end 
-- Alsh
if Redis:get(TheXlAnD.."Raumo:Change:Name:Bot"..msg.sender.user_id) then 
Redis:del(TheXlAnD.."Raumo:Change:Name:Bot"..msg.sender.user_id) 
Redis:set(TheXlAnD.."Raumo:Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "✦┇تم تغير اسم البوت الى ↫ ‹ "..text.." ›","md",true) end 
if Redis:get(TheXlAnD.."Raumo:Change:Start:Bot"..msg.sender.user_id) then  
Redis:del(TheXlAnD.."Raumo:Change:Start:Bot"..msg.sender.user_id) 
Redis:set(TheXlAnD.."Raumo:Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "✦┇تم تغيير كليشة الترحيب الى ↫ ⤈\n"..text,"md",true) end 
if Redis:get(TheXlAnD.."Raumo:Game:Smile"..msg.chat_id) then
if text == Redis:get(TheXlAnD.."Raumo:Game:Smile"..msg.chat_id) then
Redis:incrby(TheXlAnD.."Raumo:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheXlAnD.."Raumo:Game:Smile"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇لقد فزت في اللعبه \n✦┇اللعب مره اخره وارسل - سمايل او سمايلات","md",true) end end 
if Redis:get(TheXlAnD.."Raumo:Game:Monotonous"..msg.chat_id) then
if text == Redis:get(TheXlAnD.."Raumo:Game:Monotonous"..msg.chat_id) then
Redis:del(TheXlAnD.."Raumo:Game:Monotonous"..msg.chat_id)
Redis:incrby(TheXlAnD.."Raumo:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇لقد فزت في اللعبه \n✦┇اللعب مره اخره وارسل - الاسرع او ترتيب","md",true) end end 
if Redis:get(TheXlAnD.."Raumo:Game:Riddles"..msg.chat_id) then
if text == Redis:get(TheXlAnD.."Raumo:Game:Riddles"..msg.chat_id) then
Redis:incrby(TheXlAnD.."Raumo:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheXlAnD.."Raumo:Game:Riddles"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇لقد فزت في اللعبه \n✦┇اللعب مره اخره وارسل - حزوره","md",true) end end
if Redis:get(TheXlAnD.."Raumo:Game:Meaningof"..msg.chat_id) then
if text == Redis:get(TheXlAnD.."Raumo:Game:Meaningof"..msg.chat_id) then
Redis:incrby(TheXlAnD.."Raumo:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheXlAnD.."Raumo:Game:Meaningof"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇لقد فزت في اللعبه \n✦┇اللعب مره اخره وارسل - معاني","md",true) end end
if Redis:get(TheXlAnD.."Raumo:Game:Reflection"..msg.chat_id) then
if text == Redis:get(TheXlAnD.."Raumo:Game:Reflection"..msg.chat_id) then
Redis:incrby(TheXlAnD.."Raumo:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheXlAnD.."Raumo:Game:Reflection"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇لقد فزت في اللعبه \n✦┇اللعب مره اخره وارسل - العكس","md",true) end end
if Redis:get(TheXlAnD.."Raumo:Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
...
local GETNUM = Redis:get(TheXlAnD.."Raumo:Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(TheXlAnD.."Raumo:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(TheXlAnD.."Raumo:Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(TheXlAnD.."Raumo:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"✦┇مبروك فزت ويانه وخمنت الرقم الصحيح\n✦┇تم اضافة {5} من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(TheXlAnD.."Raumo:SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(TheXlAnD.."Raumo:SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(TheXlAnD.."Raumo:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(TheXlAnD.."Raumo:Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(TheXlAnD.."Raumo:Game:Difference"..msg.chat_id) then
if text == Redis:get(TheXlAnD.."Raumo:Game:Difference"..msg.chat_id) then 
Redis:del(TheXlAnD.."Raumo:Game:Difference"..msg.chat_id)
Redis:incrby(TheXlAnD.."Raumo:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇لقد فزت في اللعبه \n✦┇اللعب مره اخره وارسل - المختلف","md",true)  
else
Redis:del(TheXlAnD.."Raumo:Game:Difference"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇لقد خسرت حضا اوفر في المره القادمه\n✦┇اللعب مره اخره وارسل - المختلف","md",true) end end
if Redis:get(TheXlAnD.."Raumo:Game:Example"..msg.chat_id) then
if text == Redis:get(TheXlAnD.."Raumo:Game:Example"..msg.chat_id) then 
Redis:del(TheXlAnD.."Raumo:Game:Example"..msg.chat_id)
Redis:incrby(TheXlAnD.."Raumo:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
local Get_Chat = LuaTele.getChat(Redis:get(TheXlAnD..'Raumo:ChanneliD:Join'))
local NcH = (Redis:get(TheXlAnD.."Raumo:CH:Bot") or Get_Chat.title)
local NcHlink = (Redis:get(TheXlAnD.."Raumo:CHlink:Bot") or "✦┇عذراً لاتستطيع استخدام البوت !\n✦┇عليك الاشتراك في القناة اولاً :")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
...
Y = Y + 1
Redis:sadd(TheXlAnD..'Raumo:Num:User:Pv',v)  end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(TheXlAnD.."Raumo:ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(TheXlAnD.."Raumo:TheBasics:Group"..GroupId,v) end end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(TheXlAnD.."Raumo:Originators:Group"..GroupId,v) end end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(TheXlAnD.."Raumo:Managers:Group"..GroupId,v) end end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(TheXlAnD.."Raumo:Addictive:Group"..GroupId,v) end end
if ListGroup.Cleaner then
for k,v in pairs(ListGroup.Cleaner) do
Redis:sadd(TheXlAnD.."Raumo:Cleaner:Group"..GroupId,v) end end 
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(TheXlAnD.."Raumo:Distinguished:Group"..GroupId,v) end end 
end
...
Redis:sadd(TheXlAnD.."Raumo:ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(TheXlAnD.."Raumo:Originators:Group"..idg,idmsh) end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(TheXlAnD.."Raumo:Managers:Group"..idg,idmder)  end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(TheXlAnD.."Raumo:Addictive:Group"..idg,idmod) end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(TheXlAnD.."Raumo:TheBasics:Group"..idg,idASAS) end;end
end
...
if (Redis:get(TheXlAnD..'Raumo:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == '‹ الغاء الامر ›' then 
Redis:del(TheXlAnD..'Raumo:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id)
...
Redis:set(TheXlAnD..'Raumo:Channel:Join',ChannelUser) 
Redis:set(TheXlAnD..'Raumo:ChanneliD:Join',UserId_Info.id) 
...
if not msg.DevelopersAS then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n✦┇هذا الامر للمطور الاساسي واعلى فقط',"md",true)  end
Redis:set(TheXlAnD..'Raumo:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id,true)
return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇ارسل الي الان قناة الاشتراك ","md",true)  end
if text == 'تعطيل الاشتراك الاجباري' or text == '‹ تعطيل الاشتراك الاجباري ›' then
if not msg.DevelopersAS then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n✦┇هذا الامر للمطور الاساسي واعلى فقط',"md",true)  end
Redis:del(TheXlAnD..'Raumo:Channel:Join')
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:setex(TheXlAnD.."Raumo:Change:CH:Bot"..msg.sender.user_id,300,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheXlAnD.."Raumo:CH:Bot") 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:setex(TheXlAnD.."Raumo:Change:CHlink:Bot"..msg.sender.user_id,300,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheXlAnD.."Raumo:CHlink:Bot") 
...
local NamesBot = (Redis:get(TheXlAnD.."Raumo:Name:Bot") or "لار")
local BotName = {
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheXlAnD.."Raumo:SendBcBot") 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:SendBcBot",true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheXlAnD.."Raumo:LeftBot") 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:LeftBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"*✦┇تم تفعيل مغادرة البوت *").unLock,"md",true) end
if (Redis:get(TheXlAnD.."Raumo:AddSudosNew"..msg_chat_id) == 'true') then
Redis:del(TheXlAnD.."Raumo:AddSudosNew"..msg_chat_id)
if text and text:match("^@[%a%d_]+$") then
local UserId_Info = LuaTele.searchPublicChat(text)
...
Redis:set(TheXlAnD.."Raumo:AddSudosNew"..msg_chat_id,true)
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local Groups = Redis:smembers(TheXlAnD..'Raumo:ChekBotAdd')  
local UsersBot = Redis:smembers(TheXlAnD..'Raumo:Num:User:Pv')  
...
local President = Redis:smembers(TheXlAnD.."Raumo:TheBasics:Group"..v)
local Constructor = Redis:smembers(TheXlAnD.."Raumo:Originators:Group"..v)
local Manager = Redis:smembers(TheXlAnD.."Raumo:Managers:Group"..v)
local Admin = Redis:smembers(TheXlAnD.."Raumo:Addictive:Group"..v)
local Cleaner = Redis:smembers(TheXlAnD.."Raumo:Cleaner:Group"..v)
local Vips = Redis:smembers(TheXlAnD.."Raumo:Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
listrep = Redis:smembers(TheXlAnD.."Raumo:List:Manager"..ide.."")
if k == 1 then
...
if Redis:get(TheXlAnD.."Raumo:Add:Rd:Manager:Gif"..v..ide) then
db = "gif@"..Redis:get(TheXlAnD.."Raumo:Add:Rd:Manager:Gif"..v..ide)
elseif Redis:get(TheXlAnD.."Raumo:Add:Rd:Manager:Vico"..v..ide) then
db = "Vico@"..Redis:get(TheXlAnD.."Raumo:Add:Rd:Manager:Vico"..v..ide)
elseif Redis:get(TheXlAnD.."Raumo:Add:Rd:Manager:Stekrs"..v..ide) then
db = "Stekrs@"..Redis:get(TheXlAnD.."Raumo:Add:Rd:Manager:Stekrs"..v..ide)
elseif Redis:get(TheXlAnD.."Raumo:Add:Rd:Manager:Text"..v..ide) then
db = "Text@"..Redis:get(TheXlAnD.."Raumo:Add:Rd:Manager:Text"..v..ide)
db = string.gsub(db,'"','')
db = string.gsub(db,"'",'')
db = string.gsub(db,'*','')
db = string.gsub(db,'`','')
...
db = string.gsub(db,'}','')
db = string.gsub(db,'\n',' ')
elseif Redis:get(TheXlAnD.."Raumo:Add:Rd:Manager:Photo"..v..ide) then
db = "Photo@"..Redis:get(TheXlAnD.."Raumo:Add:Rd:Manager:Photo"..v..ide) 
elseif Redis:get(TheXlAnD.."Raumo:Add:Rd:Manager:Video"..v..ide) then
db = "Video@"..Redis:get(TheXlAnD.."Raumo:Add:Rd:Manager:Video"..v..ide)
elseif Redis:get(TheXlAnD.."Raumo:Add:Rd:Manager:File"..v..ide) then
db = "File@"..Redis:get(TheXlAnD.."Raumo:Add:Rd:Manager:File"..v..ide)
elseif Redis:get(TheXlAnD.."Raumo:Add:Rd:Manager:Audio"..v..ide) then
db = "Audio@"..Redis:get(TheXlAnD.."Raumo:Add:Rd:Manager:Audio"..v..ide)
elseif Redis:get(TheXlAnD.."Raumo:Add:Rd:Manager:video_note"..v..ide) then
db = "video_note@"..Redis:get(TheXlAnD.."Raumo:Add:Rd:Manager:video_note"..v..ide) end
v = string.gsub(v,'"','')
v = string.gsub(v,"'",'')
...
Redis:sadd(TheXlAnD.."Raumo:List:Manager"..GroupId,k)
if v and v:match('gif@(.*)') then
Redis:set(TheXlAnD.."Raumo:Add:Rd:Manager:Gif"..k..GroupId,v:match('gif@(.*)'))
elseif v and v:match('Vico@(.*)') then
Redis:set(TheXlAnD.."Raumo:Add:Rd:Manager:Vico"..k..GroupId,v:match('Vico@(.*)'))
elseif v and v:match('Stekrs@(.*)') then
Redis:set(TheXlAnD.."Raumo:Add:Rd:Manager:Stekrs"..k..GroupId,v:match('Stekrs@(.*)'))
elseif v and v:match('Text@(.*)') then
Redis:set(TheXlAnD.."Raumo:Add:Rd:Manager:Text"..k..GroupId,v:match('Text@(.*)'))
elseif v and v:match('Photo@(.*)') then
Redis:set(TheXlAnD.."Raumo:Add:Rd:Manager:Photo"..k..GroupId,v:match('Photo@(.*)'))
elseif v and v:match('Video@(.*)') then
Redis:set(TheXlAnD.."Raumo:Add:Rd:Manager:Video"..k..GroupId,v:match('Video@(.*)'))
elseif v and v:match('File@(.*)') then
Redis:set(TheXlAnD.."Raumo:Add:Rd:Manager:File"..k..GroupId,v:match('File@(.*)') )
elseif v and v:match('Audio@(.*)') then
Redis:set(TheXlAnD.."Raumo:Add:Rd:Manager:Audio"..k..GroupId,v:match('Audio@(.*)'))
elseif v and v:match('video_note@(.*)') then
Redis:set(TheXlAnD.."Raumo:Add:Rd:Manager:video_note"..k..GroupId,v:match('video_note@(.*)') ) end end end end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD..'Raumo:Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
LuaTele.sendText(msg_chat_id,msg_id,'*✦┇احصائيات البوت ↫ ⤈\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n✦┇عدد المجموعات ↫ '..(Redis:scard(TheXlAnD..'Raumo:ChekBotAdd') or 0)..'\n✦┇عدد المشتركين ↫ '..(Redis:scard(TheXlAnD..'Raumo:Num:User:Pv') or 0)..'*',"md",true)  end
...
if Redis:sismember(TheXlAnD.."Raumo:ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(TheXlAnD..'Raumo:Num:Add:Bot') or 0)) and not msg.DevelopersAS then return LuaTele.sendText(msg_chat_id,msg_id,'✦┇عدد الاعضاء قليل لا يمكن تفعيل المجموعة يجب ان يكوم اكثر من :'..Redis:get(TheXlAnD..'Raumo:Num:Add:Bot'),"md",true)  end
...
Redis:sadd(TheXlAnD.."Raumo:TheBas:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1 end end
end
...
Redis:sadd(TheXlAnD.."Raumo:ChekBotAdd",msg_chat_id)
Redis:set(TheXlAnD.."Raumo:Status:BanId"..msg_chat_id,true) ;Redis:set(TheXlAnD.."Raumo:Status:SetId"..msg_chat_id,true) 
...
if msg.can_be_deleted_for_all_users == false then return LuaTele.sendText(msg_chat_id,msg_id,"\n*✦┇عذراً البوت ليس ادمن في المجموعة يرجى ترقيته وتفعيل الصلاحيات له *","md",true)  end
if not Redis:get(TheXlAnD.."Raumo:BotFree") then return LuaTele.sendText(msg_chat_id,msg_id,"\n*✦┇الوضع الخدمي تم تعطيله من قبل مطور البوت *","md",true)  end
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if Redis:sismember(TheXlAnD.."Raumo:ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(TheXlAnD..'Raumo:Num:Add:Bot') or 0)) and not msg.DevelopersAS then return LuaTele.sendText(msg_chat_id,msg_id,'✦┇عدد الاعضاء قليل لا يمكن تفعيل المجموعة يجب ان يكوم اكثر من :'..Redis:get(TheXlAnD..'Raumo:Num:Add:Bot'),"md",true)  end
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(TheXlAnD.."Raumo:ChekBotAdd",msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id, '\n✦┇المجموعة تم تعطيلها بالتأكيد',"md",true)  
else
if not msg.ControllerBot then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
for Name_User in string.gmatch(UserInfo.first_name, "[^%s]+" ) do
...
Redis:srem(TheXlAnD.."Raumo:ChekBotAdd",msg_chat_id)
...
Redis:srem(TheXlAnD.."Raumo:ChekBotAdd",msg_chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,'*✦┇تم تعطيل المجموعة ↫ ‹ *['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..')* ›*').unLock,'md',true, false, false, false, reply_markup) end end
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(TheXlAnD.."Raumo:ChekBotAdd",msg_chat_id) then
Redis:incr(TheXlAnD..'Raumo:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:get(TheXlAnD.."Raumo:Status:Id"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"⌁ : عذراً امر الايدي معطل","md",true) end
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
local UserId = msg.sender.user_id
local RinkBot = msg.Name_Controller
local TotalMsg = Redis:get(TheXlAnD..'Raumo:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(TheXlAnD..'Raumo:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(TheXlAnD.."Raumo:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(TheXlAnD.."Raumo:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
...
Get_Is_Id = Redis:get(TheXlAnD.."Raumo:Set:Id:Group"..msg_chat_id)
if Redis:get(TheXlAnD.."Raumo:Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(TheXlAnD..'Raumo:Num:Message:User'..msg_chat_id..':'..Message_Reply.sender.user_id) or 0
local TotalEdit = Redis:get(TheXlAnD..'Raumo:Num:Message:Edit'..msg_chat_id..Message_Reply.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*⌁ : ايديه : '..UserId..
...
local TotalMsg = Redis:get(TheXlAnD..'Raumo:Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
local TotalEdit = Redis:get(TheXlAnD..'Raumo:Num:Message:Edit'..msg_chat_id..UserId_Info.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*⌁ : ايديه : '..UserId..
'\n⌁ : معرفه : @'..UserName..
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheXlAnD.."Raumo:DevelopersAS:Groups",UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"*✦┇تم تنزيله مطور اساسي بالتأكيد *").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:DevelopersAS:Groups",UserId_Info.id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheXlAnD.."Raumo:DevelopersQ:Groups",UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"*✦┇تم تنزيله مطور ثانوي بالتأكيد *").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:DevelopersQ:Groups",UserId_Info.id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheXlAnD.."Raumo:Developers:Groups",UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"✦┇تم تنزيله مطور بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:Developers:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheXlAnD.."Raumo:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"✦┇تم تنزيله مالك بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheXlAnD.."Raumo:TheBasics:Group"..msg_chat_id,UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"✦┇تم تنزيله منشئ اساسي بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheXlAnD.."Raumo:Originators:Group"..msg_chat_id,UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"✦┇تم تنزيله من المنشئين بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheXlAnD.."Raumo:Managers:Group"..msg_chat_id,UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"✦┇تم تنزيله من المدراء بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheXlAnD.."Raumo:Addictive:Group"..msg_chat_id,UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"✦┇تم تنزيله من الادمنيه بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheXlAnD.."Raumo:Cleaner:Group"..msg_chat_id,UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"✦┇تم تنزيله من منظف بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:Cleaner:Group"..msg_chat_id,UserId_Info.id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheXlAnD.."Raumo:Distinguished:Group"..msg_chat_id,UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"✦┇تم تنزيله من المميزين بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheXlAnD.."Raumo:DevelopersAS:Groups",Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✦┇تم تنزيله مطور اساسي بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:DevelopersAS:Groups",Message_Reply.sender.user_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheXlAnD.."Raumo:DevelopersQ:Groups",Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✦┇تم تنزيله مطور ثانوي بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheXlAnD.."Raumo:Developers:Groups",Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✦┇تم تنزيله مطور بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:Developers:Groups",Message_Reply.sender.user_id) 
...
if not msg.Developers then return LuaTele.sendText(msg_chat_id,msg_id,'\n✦┇هذا الامر للمطورين واعلى فقط',"md",true)  end
if not Redis:sismember(TheXlAnD.."Raumo:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✦┇تم تنزيله مالك بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheXlAnD.."Raumo:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✦┇تم تنزيله منشئ اساسي بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheXlAnD.."Raumo:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✦┇تم تنزيله من المنشئين بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheXlAnD.."Raumo:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✦┇تم تنزيله من المدراء بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheXlAnD.."Raumo:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✦┇تم تنزيله من الادمنيه بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheXlAnD.."Raumo:Cleaner:Group"..msg_chat_id,Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✦┇تم تنزيله من منظف بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:Cleaner:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheXlAnD.."Raumo:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✦┇تم تنزيله من المميزين بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheXlAnD.."Raumo:DevelopersAS:Groups",UserId) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"*✦┇تم تنزيله مطور اساسي بالتأكيد *").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:DevelopersAS:Groups",UserId) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheXlAnD.."Raumo:DevelopersQ:Groups",UserId) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"*✦┇تم تنزيله مطور ثانوي بالتأكيد *").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:DevelopersQ:Groups",UserId) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheXlAnD.."Raumo:Developers:Groups",UserId) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"✦┇تم تنزيله مطور بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:Developers:Groups",UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"✦┇تم تنزيله مطور ").Reply,"md",true) end end
if UserId[1] == "مالك" then
if not msg.Developers then return LuaTele.sendText(msg_chat_id,msg_id,'\n✦┇هذا الامر للمطورين واعلى فقط',"md",true)  end
if not Redis:sismember(TheXlAnD.."Raumo:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"✦┇تم تنزيله مالك بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheXlAnD.."Raumo:TheBasics:Group"..msg_chat_id,UserId[2]) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"✦┇تم تنزيله منشئ اساسي بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheXlAnD.."Raumo:Originators:Group"..msg_chat_id,UserId[2]) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"✦┇تم تنزيله من المنشئين بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:Originators:Group"..msg_chat_id,UserId[2]) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheXlAnD.."Raumo:Managers:Group"..msg_chat_id,UserId[2]) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"✦┇تم تنزيله من المدراء بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:Managers:Group"..msg_chat_id,UserId[2]) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheXlAnD.."Raumo:Addictive:Group"..msg_chat_id,UserId[2]) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"✦┇تم تنزيله من الادمنيه بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:Addictive:Group"..msg_chat_id,UserId[2]) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheXlAnD.."Raumo:Cleaner:Group"..msg_chat_id,UserId[2]) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"✦┇تم تنزيله من منظف بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:Cleaner:Group"..msg_chat_id,UserId[2]) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:sismember(TheXlAnD.."Raumo:Distinguished:Group"..msg_chat_id,UserId[2]) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"✦┇تم تنزيله من المميزين بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheXlAnD.."Raumo:DevelopersAS:Groups",UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"✦┇تم رفعه مطور اساسي بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:DevelopersAS:Groups",UserId_Info.id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheXlAnD.."Raumo:DevelopersQ:Groups",UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"✦┇تم رفعه مطور ثانوي بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:DevelopersQ:Groups",UserId_Info.id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheXlAnD.."Raumo:Developers:Groups",UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"✦┇تم رفعه مطور بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:Developers:Groups",UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"✦┇تم رفعه مطور ").Reply,"md",true) end end
if UserName[1] == "مالك" then
if not msg.Developers then return LuaTele.sendText(msg_chat_id,msg_id,'\n✦┇هذا الامر للمطورين واعلى فقط',"md",true)  end
if Redis:sismember(TheXlAnD.."Raumo:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"✦┇تم رفعه مالك بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheXlAnD.."Raumo:TheBasics:Group"..msg_chat_id,UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"✦┇تم رفعه في قائمة المنشئين الاساسيين بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheXlAnD.."Raumo:Originators:Group"..msg_chat_id,UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"✦┇تم رفعه في قائمة المنشئين بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheXlAnD.."Raumo:Managers:Group"..msg_chat_id,UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"✦┇تم رفعه في قائمة المدراء بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not msg.Originators and not Redis:get(TheXlAnD.."Raumo:Status:SetId"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"✦┇تم تعطيل (الرفع) من قبل المنشئين","md",true) end 
if Redis:sismember(TheXlAnD.."Raumo:Addictive:Group"..msg_chat_id,UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"✦┇تم رفعه في قائمة الادمنية بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheXlAnD.."Raumo:Cleaner:Group"..msg_chat_id,UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"✦┇تم رفعه منظف بالتأكيد").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:Cleaner:Group"..msg_chat_id,UserId_Info.id) 
...
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not msg.Originators and not Redis:get(TheXlAnD.."Raumo:Status:SetId"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"✦┇تم تعطيل (الرفع) من قبل المنشئين","md",true) end 
if Redis:sismember(TheXlAnD.."Raumo:Distinguished:Group"..msg_chat_id,UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"✦┇تم رفعه في قائمة المميزين بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheXlAnD.."Raumo:DevelopersAS:Groups",Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✦┇تم رفعه مطور اساسي بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:DevelopersAS:Groups",Message_Reply.sender.user_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheXlAnD.."Raumo:DevelopersQ:Groups",Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✦┇تم رفعه مطور ثانوي بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheXlAnD.."Raumo:Developers:Groups",Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✦┇تم رفعه مطور بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:Developers:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✦┇تم رفعه مطور ").Reply,"md",true) end end
if TextMsg == "مالك" then
if not msg.Developers then return LuaTele.sendText(msg_chat_id,msg_id,'\n✦┇هذا الامر للمطورين واعلى فقط',"md",true)  end
if Redis:sismember(TheXlAnD.."Raumo:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✦┇تم رفعه مالك بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheXlAnD.."Raumo:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✦┇تم رفعه في قائمة المنشئين الاساسيين بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheXlAnD.."Raumo:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✦┇تم رفعه في قائمة المنشئين بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheXlAnD.."Raumo:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✦┇تم رفعه في قائمة المدراء بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not msg.Originators and not Redis:get(TheXlAnD.."Raumo:Status:SetId"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"✦┇تم تعطيل (الرفع) من قبل المنشئين","md",true) end 
if Redis:sismember(TheXlAnD.."Raumo:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✦┇تم رفعه في قائمة الادمنية بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheXlAnD.."Raumo:Cleaner:Group"..msg_chat_id,Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✦┇تم رفعه منظف بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:Cleaner:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not msg.Originators and not Redis:get(TheXlAnD.."Raumo:Status:SetId"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"✦┇تم تعطيل (الرفع) من قبل المنشئين","md",true) end 
if Redis:sismember(TheXlAnD.."Raumo:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✦┇تم رفعه في قائمة المميزين بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheXlAnD.."Raumo:DevelopersAS:Groups",UserId) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"✦┇تم رفعه مطور اساسي بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:DevelopersAS:Groups",UserId) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheXlAnD.."Raumo:DevelopersQ:Groups",UserId) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"✦┇تم رفعه مطور ثانوي بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:DevelopersQ:Groups",UserId) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheXlAnD.."Raumo:Developers:Groups",UserId) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"✦┇تم رفعه مطور بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:Developers:Groups",UserId) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheXlAnD.."Raumo:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"✦┇تم رفعه مالك بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheXlAnD.."Raumo:TheBasics:Group"..msg_chat_id,UserId[2]) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"✦┇تم رفعه في قائمة المنشئين الاساسيين بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheXlAnD.."Raumo:Originators:Group"..msg_chat_id,UserId[2]) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"✦┇تم رفعه في قائمة المنشئين بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:Originators:Group"..msg_chat_id,UserId[2]) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheXlAnD.."Raumo:Managers:Group"..msg_chat_id,UserId[2]) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"✦┇تم رفعه في قائمة المدراء بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:Managers:Group"..msg_chat_id,UserId[2]) 
...
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not msg.Originators and not Redis:get(TheXlAnD.."Raumo:Status:SetId"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"✦┇تم تعطيل (الرفع) من قبل المنشئين","md",true) end 
if Redis:sismember(TheXlAnD.."Raumo:Addictive:Group"..msg_chat_id,UserId[2]) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"✦┇تم رفعه في قائمة الادمنية بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:Addictive:Group"..msg_chat_id,UserId[2]) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:sismember(TheXlAnD.."Raumo:Cleaner:Group"..msg_chat_id,UserId[2]) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"✦┇تم رفعه منظف بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:Cleaner:Group"..msg_chat_id,UserId[2]) 
...
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not msg.Originators and not Redis:get(TheXlAnD.."Raumo:Status:SetId"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"✦┇تم تعطيل (الرفع) من قبل المنشئين","md",true) end 
if Redis:sismember(TheXlAnD.."Raumo:Distinguished:Group"..msg_chat_id,UserId[2]) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"✦┇تم رفعه في قائمة المميزين بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if not msg.Managers then return LuaTele.sendText(msg_chat_id,msg_id,'\n✦┇هذا الامر للمدراء واعلى فقط',"md",true)  end
Redis:set(TheXlAnD.."Raumo:Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(TheXlAnD.."Raumo:President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheXlAnD.."Raumo:Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheXlAnD.."Raumo:Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(TheXlAnD.."Raumo:Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheXlAnD.."Raumo:Vip:Group:Reply"..msg.chat_id,Teext)
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local Info_Members = Redis:smembers(TheXlAnD.."Raumo:DevelopersAS:Groups") 
local Alsh = Redis:scard(TheXlAnD.."Raumo:DevelopersAS:Groups") 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local Info_Members = Redis:smembers(TheXlAnD.."Raumo:DevelopersQ:Groups") 
local Alsh = Redis:scard(TheXlAnD.."Raumo:DevelopersQ:Groups") 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local Info_Members = Redis:smembers(TheXlAnD.."Raumo:Developers:Groups") 
local Alsh = Redis:scard(TheXlAnD.."Raumo:Developers:Groups")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local Info_Members = Redis:smembers(TheXlAnD.."Raumo:TheBasicsQ:Group"..msg_chat_id) 
local Alsh = Redis:scard(TheXlAnD.."Raumo:TheBasicsQ:Group"..msg_chat_id)
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local Info_Members = Redis:smembers(TheXlAnD.."Raumo:TheBasics:Group"..msg_chat_id) 
local Alsh = Redis:scard(TheXlAnD.."Raumo:TheBasics:Group"..msg_chat_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local Info_Members = Redis:smembers(TheXlAnD.."Raumo:Originators:Group"..msg_chat_id) 
local Alsh = Redis:scard(TheXlAnD.."Raumo:Originators:Group"..msg_chat_id)
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local Info_Members = Redis:smembers(TheXlAnD.."Raumo:Managers:Group"..msg_chat_id) 
local Alsh = Redis:scard(TheXlAnD.."Raumo:Managers:Group"..msg_chat_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local Info_Members = Redis:smembers(TheXlAnD.."Raumo:Addictive:Group"..msg_chat_id) 
local Alsh = Redis:scard(TheXlAnD.."Raumo:Addictive:Group"..msg_chat_id)
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local Info_Members = Redis:smembers(TheXlAnD.."Raumo:Cleaner:Group"..msg_chat_id) 
local Alsh = Redis:scard(TheXlAnD.."Raumo:Cleaner:Group"..msg_chat_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local Info_Members = Redis:smembers(TheXlAnD.."Raumo:Distinguished:Group"..msg_chat_id) 
local Alsh = Redis:scard(TheXlAnD.."Raumo:Distinguished:Group"..msg_chat_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local Info_Members = Redis:smembers(TheXlAnD.."Raumo:BanAll:Groups") 
...
local Info_Memberss = Redis:smembers(TheXlAnD.."Raumo:ktmAll:Groups") 
...
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local Info_Members = Redis:smembers(TheXlAnD.."Raumo:BanAll:Groups") 
local Alsh = Redis:scard(TheXlAnD.."Raumo:BanAll:Groups") 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local Info_Members = Redis:smembers(TheXlAnD.."Raumo:ktmAll:Groups") 
local Alsh = Redis:scard(TheXlAnD.."Raumo:ktmAll:Groups") 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local Info_Members = Redis:smembers(TheXlAnD.."Raumo:BanGroup:Group"..msg_chat_id) 
local Alsh = Redis:scard(TheXlAnD.."Raumo:BanGroup:Group"..msg_chat_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local Info_Members = Redis:smembers(TheXlAnD.."Raumo:SilentGroup:Group"..msg_chat_id) 
local Alsh = Redis:scard(TheXlAnD.."Raumo:SilentGroup:Group"..msg_chat_id) 
...
Redis:set(TheXlAnD.."Raumo:Status:distraction10"..msg_chat_id,true) 
Redis:set(TheXlAnD.."Raumo:Status:distraction9"..msg_chat_id,true) 
Redis:set(TheXlAnD.."Raumo:Status:distraction8"..msg_chat_id,true) 
Redis:set(TheXlAnD.."Raumo:Status:distraction7"..msg_chat_id,true) 
Redis:set(TheXlAnD.."Raumo:Status:distraction6"..msg_chat_id,true) 
Redis:set(TheXlAnD.."Raumo:Status:distraction5"..msg_chat_id,true) 
Redis:set(TheXlAnD.."Raumo:Status:distraction4"..msg_chat_id,true) 
Redis:set(TheXlAnD.."Raumo:Status:distraction3"..msg_chat_id,true) 
Redis:set(TheXlAnD.."Raumo:Status:distraction2"..msg_chat_id,true) 
Redis:set(TheXlAnD.."Raumo:Status:distraction1"..msg_chat_id,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Status:Id"..msg_chat_id,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Status:IdPhoto"..msg_chat_id,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Status:Reply"..msg_chat_id,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Status:ReplySudo"..msg_chat_id,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Status:BanId"..msg_chat_id,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Status:SetId"..msg_chat_id,true) 
...
Redis:set(TheXlAnD.."Raumo:Status:Games"..msg_chat_id,true) 
...
Redis:set(TheXlAnD.."Raumo:Status:KickMe"..msg_chat_id,true) 
...
Redis:set(TheXlAnD.."Raumo:Status:gamle"..msg_chat_id,true) 
...
Redis:set(TheXlAnD.."Raumo:rb:bna"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"✦┇ تم تفعيل ردود السورس ","md",true)
end
if TextMsg == 'نزلني' then
Redis:set(TheXlAnD.."Raumo:Status:remMe"..msg_chat_id,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:BotFree",true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:TwaslBot",true) 
...
-- Alsh
if text and text:match("^(.*)$") then
if Redis:get(TheXlAnD.."Raumo1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
local reply_markup = LuaTele.replyMarkup{type = 'inline',
data = {{{text = '‹ الغاء ›', data = msg.sender.user_id..'/closerd0'},},}}
Redis:set(TheXlAnD.."Raumo1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(TheXlAnD.."Raumo1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(TheXlAnD.."Raumo1:List:Rd:Sudo"..msg.chat_id, text)
return LuaTele.sendText(msg_chat_id,msg_id, '\n✦┇تم حفظ الكلمة \n✦┇الان ارسل الرد رقم ↫ ‹ 1 ›', "md", false, false, false, false, reply_markup) end end
if text and text:match("^(.*)$") then
if Redis:get(TheXlAnD.."Raumo1:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(TheXlAnD..'Raumo1:Add:Rd:Sudo:Text'..text..msg.chat_id)
Redis:del(TheXlAnD..'Raumo1:Add:Rd:Sudo:Text1'..text..msg.chat_id)
Redis:del(TheXlAnD..'Raumo1:Add:Rd:Sudo:Text2'..text..msg.chat_id)
Redis:del(TheXlAnD..'Raumo1:Add:Rd:Sudo:Text3'..text..msg.chat_id)
Redis:del(TheXlAnD..'Raumo1:Add:Rd:Sudo:Text4'..text..msg.chat_id)
Redis:del(TheXlAnD.."Raumo1:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(TheXlAnD.."Raumo1:List:Rd:Sudo"..msg.chat_id, text)
...
Redis:set(TheXlAnD.."Raumo1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(TheXlAnD.."Raumo1:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return LuaTele.sendText(msg_chat_id,msg_id,"✦┇ارسل الان الكلمه لحذفها ", "md", false, false, false, false, reply_markup) end
if text then  
local test = Redis:get(TheXlAnD.."Raumo1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheXlAnD.."Raumo1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(TheXlAnD.."Raumo1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheXlAnD.."Raumo1:Add:Rd:Sudo:Text"..test..msg.chat_id, text)  end  
local reply_markup = LuaTele.replyMarkup{type = 'inline',
...
if text then  
local test = Redis:get(TheXlAnD.."Raumo1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheXlAnD.."Raumo1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(TheXlAnD.."Raumo1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheXlAnD.."Raumo1:Add:Rd:Sudo:Text1"..test..msg.chat_id, text)  end  
local reply_markup = LuaTele.replyMarkup{type = 'inline',
...
if text then  
local test = Redis:get(TheXlAnD.."Raumo1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheXlAnD.."Raumo1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(TheXlAnD.."Raumo1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheXlAnD.."Raumo1:Add:Rd:Sudo:Text2"..test..msg.chat_id, text)  end  
local reply_markup = LuaTele.replyMarkup{type = 'inline',
...
if text then  
local test = Redis:get(TheXlAnD.."Raumo1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheXlAnD.."Raumo1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd3" then
Redis:set(TheXlAnD.."Raumo1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd4')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheXlAnD.."Raumo1:Add:Rd:Sudo:Text3"..test..msg.chat_id, text)  end  
local reply_markup = LuaTele.replyMarkup{type = 'inline',
...
if text then  
local test = Redis:get(TheXlAnD.."Raumo1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheXlAnD.."Raumo1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd4" then
Redis:set(TheXlAnD.."Raumo1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd5')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheXlAnD.."Raumo1:Add:Rd:Sudo:Text4"..test..msg.chat_id, text)  end  
local reply_markup = LuaTele.replyMarkup{type = 'inline',
...
if text then
local Text = Redis:get(TheXlAnD.."Raumo1:Add:Rd:Sudo:Text"..text..msg.chat_id)   
local Text1 = Redis:get(TheXlAnD.."Raumo1:Add:Rd:Sudo:Text1"..text..msg.chat_id)   
local Text2 = Redis:get(TheXlAnD.."Raumo1:Add:Rd:Sudo:Text2"..text..msg.chat_id)   
local Text3 = Redis:get(TheXlAnD.."Raumo1:Add:Rd:Sudo:Text3"..text..msg.chat_id)   
local Text4 = Redis:get(TheXlAnD.."Raumo1:Add:Rd:Sudo:Text4"..text..msg.chat_id)   
...
-- Alsh
if text and text:match("^(.*)$") then
if Redis:get(TheXlAnD.."Raumo11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
local reply_markup = LuaTele.replyMarkup{type = 'inline',
data = {{{text = '‹ الغاء ›', data = msg.sender.user_id..'/closerd0bot'},},}}
LuaTele.sendText(msg_chat_id,msg_id, '\n✦┇تم حفظ الكلمة \n✦┇الان ارسل الرد رقم ↫ ‹ 1 ›', "md", false, false, false, false, reply_markup)
Redis:set(TheXlAnD.."Raumo11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(TheXlAnD.."Raumo11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(TheXlAnD.."Raumo11:List:Rd:Sudo", text)
return false end end
if text and text:match("^(.*)$") then
if Redis:get(TheXlAnD.."Raumo11:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id,"✦┇تم حذف الرد من ردود المتعدده")
Redis:del(TheXlAnD..'Raumo11:Add:Rd:Sudo:Text'..text)
Redis:del(TheXlAnD..'Raumo11:Add:Rd:Sudo:Text1'..text)
Redis:del(TheXlAnD..'Raumo11:Add:Rd:Sudo:Text2'..text)
Redis:del(TheXlAnD.."Raumo11:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(TheXlAnD.."Raumo11:List:Rd:Sudo", text)
return false end end
...
Redis:set(TheXlAnD.."Raumo11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(TheXlAnD.."Raumo11:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"✦┇ارسل الان الكلمه لحذفها ", "md", false, false, false, false, reply_markup) end
if text then  
local test = Redis:get(TheXlAnD.."Raumo11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheXlAnD.."Raumo11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(TheXlAnD.."Raumo11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheXlAnD.."Raumo11:Add:Rd:Sudo:Text"..test, text)  end  
local reply_markup = LuaTele.replyMarkup{type = 'inline',
...
if text then  
local test = Redis:get(TheXlAnD.."Raumo11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheXlAnD.."Raumo11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(TheXlAnD.."Raumo11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheXlAnD.."Raumo11:Add:Rd:Sudo:Text1"..test, text)  end  
local reply_markup = LuaTele.replyMarkup{type = 'inline',
...
if text then  
local test = Redis:get(TheXlAnD.."Raumo11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheXlAnD.."Raumo11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(TheXlAnD.."Raumo11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheXlAnD.."Raumo11:Add:Rd:Sudo:Text2"..test, text)  end  
local reply_markup = LuaTele.replyMarkup{type = 'inline',
...
if text then
local Text = Redis:get(TheXlAnD.."Raumo11:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(TheXlAnD.."Raumo11:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(TheXlAnD.."Raumo11:Add:Rd:Sudo:Text2"..text)   
...
Redis:set(TheXlAnD..'Raumo:Num:Add:Bot'..msg_chat_id,text:match("عدد المسح (%d+)$") ) 
...
LuaTele.sendText(msg_chat_id,msg_id,'✦┇عدد المسح الحالي ↫ ‹ *'..(Redis:get(TheXlAnD..'Raumo:Num:Add:Bot'..msg_chat_id) or 150)..'* › ',"md",true)  end
-- 
...
Redis:sadd(TheXlAnD.."Raumo:allM"..msg.chat_id, msg.id)
if Redis:get(TheXlAnD.."Raumo:Status:Del:Media"..msg.chat_id) then    
local gmedia = Redis:scard(TheXlAnD.."Raumo:allM"..msg.chat_id)  
if gmedia >= tonumber((Redis:get(TheXlAnD..'Raumo:Num:Add:Bot'..msg_chat_id) or 150)) then
local liste = Redis:smembers(TheXlAnD.."Raumo:allM"..msg.chat_id)
...
Redis:del(TheXlAnD.."Raumo:allM"..msg.chat_id) end end
end
if text == ("امسح") and msg.Cleaner then  
local list = Redis:smembers(TheXlAnD.."Raumo:allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(TheXlAnD.."Raumo:allM"..msg.chat_id)  
if gmria == 0 then
...
Redis:del(TheXlAnD.."Raumo:Status:Del:Media"..msg.chat_id)
...
Redis:set(TheXlAnD.."Raumo:Status:Del:Media"..msg.chat_id,true)
...
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if TextMsg == 'اوامر التسليه' then
Redis:del(TheXlAnD.."Raumo:Status:distraction10"..msg_chat_id,true) 
Redis:del(TheXlAnD.."Raumo:Status:distraction9"..msg_chat_id,true) 
Redis:del(TheXlAnD.."Raumo:Status:distraction8"..msg_chat_id,true) 
Redis:del(TheXlAnD.."Raumo:Status:distraction7"..msg_chat_id,true) 
Redis:del(TheXlAnD.."Raumo:Status:distraction6"..msg_chat_id,true) 
Redis:del(TheXlAnD.."Raumo:Status:distraction5"..msg_chat_id,true) 
Redis:del(TheXlAnD.."Raumo:Status:distraction4"..msg_chat_id,true) 
Redis:del(TheXlAnD.."Raumo:Status:distraction3"..msg_chat_id,true) 
Redis:del(TheXlAnD.."Raumo:Status:distraction2"..msg_chat_id,true) 
Redis:del(TheXlAnD.."Raumo:Status:distraction1"..msg_chat_id,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheXlAnD.."Raumo:Status:Id"..msg_chat_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheXlAnD.."Raumo:Status:IdPhoto"..msg_chat_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheXlAnD.."Raumo:Status:Reply"..msg_chat_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheXlAnD.."Raumo:Status:ReplySudo"..msg_chat_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheXlAnD.."Raumo:Status:BanId"..msg_chat_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheXlAnD.."Raumo:BotFree") 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheXlAnD.."Raumo:TwaslBot") 
...
if Redis:sismember(TheXlAnD.."Raumo:BanAll:Groups",UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"✦┇تم حظره عام من المجموعات بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:BanAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheXlAnD.."Raumo:BanAll:Groups",UserId) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"✦┇تم الغاء حظره عام من المجموعات بالتأكيد").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:BanAll:Groups",UserId) 
...
if UserId_Info.type.is_channel == true then return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇عذراً لا تستطيع استخدام معرف قناة او كروب ","md",true)  end
if UserName and UserName:match('(%S+)[Bb][Oo][Tt]') then return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇عذراً لا تستطيع استخدام معرف البوت ","md",true)  end
if not Redis:sismember(TheXlAnD.."Raumo:BanAll:Groups",UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"✦┇تم الغاء حظره عام من المجموعات بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:BanAll:Groups",UserId_Info.id) 
...
if Controller(msg_chat_id,UserId_Info.id) == 'مبرمج السورس' then return LuaTele.sendText(msg_chat_id,msg_id,"\n*✦┇عذرا لا تستطيع كتم عام ‹ "..Controller(msg_chat_id,UserId_Info.id).." ›*","md",true)  end
if Controller(msg_chat_id,UserId_Info.id) == 'مبرمج السورس' then return LuaTele.sendText(msg_chat_id,msg_id,"\n*✦┇عذرا لا تستطيع كتم عام ‹ "..Controller(msg_chat_id,UserId_Info.id).." ›*","md",true)  end
if Redis:sismember(TheXlAnD.."Raumo:ktmAll:Groups",UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"✦┇تم كتمه عام من المجموعات بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:ktmAll:Groups",UserId_Info.id) 
...
local UserInfo = LuaTele.getUser(UserId)
if UserInfo.luatele == "error" and UserInfo.code == 6 then return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇عذراً لا تستطيع استخدام ايدي خطأ ","md",true)  end
if not Redis:sismember(TheXlAnD.."Raumo:ktmAll:Groups",UserId) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"✦┇تم الغاء كتمه عام من المجموعات بالتأكيد").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:ktmAll:Groups",UserId) 
...
if UserId_Info.type.is_channel == true then return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇عذرا لا تستطيع استخدام معرف قناة او كروب ","md",true)  end
if UserName and UserName:match('(%S+)[Bb][Oo][Tt]') then return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇عذرا لا تستطيع استخدام معرف البوت ","md",true)  end
if not Redis:sismember(TheXlAnD.."Raumo:ktmAll:Groups",UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"✦┇تم الغاء كتمه عام من المجموعات بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:ktmAll:Groups",UserId_Info.id) 
...
if not msg.Originators and not Redis:get(TheXlAnD.."Raumo:Status:BanId"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"✦┇تم تعطيل ( الحظر • الطرد • التقييد ) من قبل المدراء","md",true) end 
local UserId_Info = LuaTele.searchPublicChat(UserName)
if not UserId_Info.id then return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇عذراً لا يوجد حساب بهذا المعرف ","md",true)  end
if UserId_Info.type.is_channel == true then return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇عذراً لا تستطيع استخدام معرف قناة او كروب ","md",true)  end
if UserName and UserName:match('(%S+)[Bb][Oo][Tt]') then return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇عذراً لا تستطيع استخدام معرف البوت ","md",true)  end
if StatusCanOrNotCan(msg_chat_id,UserId_Info.id) and not Distinguished then return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇عذراً لا تستطيع حظر ↫ ‹ "..Controller(msg_chat_id,UserId_Info.id).." › ","md",true)  end
if Redis:sismember(TheXlAnD.."Raumo:BanGroup:Group"..msg_chat_id,UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"✦┇تم حظره من المجموعة بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
...
if UserId_Info.type.is_channel == true then return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇عذراً لا تستطيع استخدام معرف قناة او كروب ","md",true)  end
if UserName and UserName:match('(%S+)[Bb][Oo][Tt]') then return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇عذراً لا تستطيع استخدام معرف البوت ","md",true)  end
if not Redis:sismember(TheXlAnD.."Raumo:BanGroup:Group"..msg_chat_id,UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"✦┇تم الغاء حظره من المجموعة بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheXlAnD.."Raumo:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"✦┇تم كتمه في المجموعة بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
...
if UserId_Info.type.is_channel == true then return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇عذراً لا تستطيع استخدام معرف قناة او كروب ","md",true)  end
if UserName and UserName:match('(%S+)[Bb][Oo][Tt]') then return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇عذراً لا تستطيع استخدام معرف البوت ","md",true)  end
if not Redis:sismember(TheXlAnD.."Raumo:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"✦┇تم الغاء كتمه من المجموعة ").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheXlAnD.."Raumo:BanAll:Groups",Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✦┇تم حظره عام من المجموعات بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:BanAll:Groups",Message_Reply.sender.user_id) 
...
if UserInfo.message == "Invalid user ID" then return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇عذراً تستطيع فقط استخدام الامر على المستخدمين ","md",true)  end
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇عذراً لا تستطيع استخدام الامر على البوت ","md",true)  end
if not Redis:sismember(TheXlAnD.."Raumo:BanAll:Groups",Message_Reply.sender.user_id) and not Redis:sismember(TheXlAnD.."Raumo:ktmAll:Groups",Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✦┇تم الغاء ( الحظر • الكتم ) العام عنه بالتأكيد").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:BanAll:Groups",Message_Reply.sender.user_id) 
Redis:srem(TheXlAnD.."Raumo:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if UserInfo.message == "Invalid user ID" then return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇عذراً تستطيع فقط استخدام الامر على المستخدمين ","md",true)  end
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇عذراً لا تستطيع استخدام الامر على البوت ","md",true)  end
if not Redis:sismember(TheXlAnD.."Raumo:BanAll:Groups",Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✦┇تم الغاء حظره عام من المجموعات بالتأكيد").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:BanAll:Groups",Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'مبرمج السورس' then return LuaTele.sendText(msg_chat_id,msg_id,"\n*✦┇عذرا لا تستطيع كتم عام ‹ "..Controller(msg_chat_id,Message_Reply.sender.user_id).." ›*","md",true)  end
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'مبرمج السورس' then return LuaTele.sendText(msg_chat_id,msg_id,"\n*✦┇عذرا لا تستطيع كتم عام ‹ "..Controller(msg_chat_id,Message_Reply.sender.user_id).." ›*","md",true)  end
if Redis:sismember(TheXlAnD.."Raumo:ktmAll:Groups",Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✦┇تم كتمه عام من المجموعات بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if ban.message == "Invalid user ID" then return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇عذرا تستطيع فقط استخدام الامر على المستخدمين ","md",true)  end
if ban and ban.type and ban.type.luatele == "userTypeBot" then return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇عذرا لا تستطيع استخدام الامر على البوت ","md",true)  end
if not Redis:sismember(TheXlAnD.."Raumo:ktmAll:Groups",Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✦┇تم الغاء كتمه عام من المجموعات بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇عذراً لا تستطيع استخدام الامر على البوت ","md",true)  end
if StatusCanOrNotCan(msg_chat_id,Message_Reply.sender.user_id) and not Distinguished then return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇عذراً لا تستطيع حظر ↫ ‹ "..Controller(msg_chat_id,Message_Reply.sender.user_id).." › ","md",true)  end
if Redis:sismember(TheXlAnD.."Raumo:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✦┇تم حظره من المجموعة بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if UserInfo.message == "Invalid user ID" then return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇عذراً تستطيع فقط استخدام الامر على المستخدمين ","md",true)  end
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇عذراً لا تستطيع استخدام الامر على البوت ","md",true)  end
if not Redis:sismember(TheXlAnD.."Raumo:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✦┇تم الغاء حظره من المجموعة بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheXlAnD.."Raumo:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✦┇تم كتمه في المجموعة بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if UserInfo.message == "Invalid user ID" then return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇عذراً تستطيع فقط استخدام الامر على المستخدمين ","md",true)  end
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇عذراً لا تستطيع استخدام الامر على البوت ","md",true)  end
if not Redis:sismember(TheXlAnD.."Raumo:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"✦┇تم الغاء كتمه من المجموعة ").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheXlAnD.."Raumo:BanAll:Groups",UserId) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"✦┇تم حظره عام من المجموعات بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:BanAll:Groups",UserId) 
...
if Redis:sismember(TheXlAnD.."Raumo:ktmAll:Groups",UserId) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"✦┇تم كتمه عام من المجموعات بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:ktmAll:Groups",UserId) 
...
local UserInfo = LuaTele.getUser(UserId)
if UserInfo.luatele == "error" and UserInfo.code == 6 then return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇عذراً لا تستطيع استخدام ايدي خطأ ","md",true)  end
if not Redis:sismember(TheXlAnD.."Raumo:BanAll:Groups",UserId) and not Redis:sismember(TheXlAnD.."Raumo:ktmAll:Groups",UserId) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"✦┇تم الغاء ( الحظر • الكتم ) العام عنه بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:BanAll:Groups",UserId) 
Redis:srem(TheXlAnD.."Raumo:ktmAll:Groups",UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if UserId_Info.type.is_channel == true then return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇عذراً لا تستطيع استخدام معرف قناة او كروب ","md",true)  end
if UserName and UserName:match('(%S+)[Bb][Oo][Tt]') then return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇عذراً لا تستطيع استخدام معرف البوت ","md",true)  end
if not Redis:sismember(TheXlAnD.."Raumo:BanAll:Groups",UserId_Info.id) and not Redis:sismember(TheXlAnD.."Raumo:ktmAll:Groups",UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"✦┇تم الغاء ( الحظر • الكتم ) العام عنه بالتأكيد").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:BanAll:Groups",UserId_Info.id) 
Redis:srem(TheXlAnD.."Raumo:ktmAll:Groups",UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheXlAnD.."Raumo:BanGroup:Group"..msg_chat_id,UserId) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"✦┇تم حظره من المجموعة بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
local UserInfo = LuaTele.getUser(UserId)
if UserInfo.luatele == "error" and UserInfo.code == 6 then return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇عذراً لا تستطيع استخدام ايدي خطأ ","md",true)  end
if not Redis:sismember(TheXlAnD.."Raumo:BanGroup:Group"..msg_chat_id,UserId) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"✦┇تم الغاء حظره من المجموعة بالتأكيد ").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheXlAnD.."Raumo:SilentGroup:Group"..msg_chat_id,UserId) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"✦┇تم كتمه في المجموعة بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(TheXlAnD.."Raumo:SilentGroup:Group"..msg_chat_id,UserId) 
...
local UserInfo = LuaTele.getUser(UserId)
if UserInfo.luatele == "error" and UserInfo.code == 6 then return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇عذراً لا تستطيع استخدام ايدي خطأ ","md",true)  end
if not Redis:sismember(TheXlAnD.."Raumo:SilentGroup:Group"..msg_chat_id,UserId) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"✦┇تم الغاء كتمه من المجموعة ").Reply,"md",true)  
else
Redis:srem(TheXlAnD.."Raumo:SilentGroup:Group"..msg_chat_id,UserId) 
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TheXlAnD.."Raumo:TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(TheXlAnD.."Raumo:Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1 end end
end
...
local OwnText = Redis:get(TheXlAnD..'Raumo:Owner:OwnerTheXlAnD'..msg_chat_id)
if not msg.ControllerBot then
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Fshar"..msg_chat_id,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Taf"..msg_chat_id,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Kfr"..msg_chat_id,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Farsi"..msg_chat_id,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:text"..msg_chat_id,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
Redis:set(TheXlAnD.."Raumo:Lock:AddMempar"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
Redis:set(TheXlAnD.."Raumo:Lock:Join"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
Redis:set(TheXlAnD.."Raumo:Lock:Bot:kick"..msg_chat_id,"del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
Redis:set(TheXlAnD.."Raumo:Lock:Bot:kick"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end  
Redis:set(TheXlAnD.."Raumo:Lock:tagservr"..msg_chat_id,true)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end  
Redis:set(TheXlAnD.."Raumo:lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
Redis:set(TheXlAnD.."Raumo:Lock:edit"..msg_chat_id,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end  
Redis:set(TheXlAnD.."Raumo:Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(TheXlAnD..'Raumo:'..lock..msg_chat_id,"del")    
end
...
if Redis:get(TheXlAnD.."Raumo:myzhrfa"..msg.chat_id)  then
LuaTele.sendText(msg_chat_id,msg_id, '✦︙تم تعطيل امر الزخرفه مسبقا\n ✓',"md")
else
Redis:set(TheXlAnD.."Raumo:myzhrfa"..msg.chat_id,"true")
...
if not Redis:get(TheXlAnD.."Raumo:myzhrfa"..msg.chat_id)  then
LuaTele.sendText(msg_chat_id,msg_id, '✦︙تم تفعيل امر الزخرفه مسبقا\n ✓',"md")
else
Redis:del(TheXlAnD.."Raumo:myzhrfa"..msg.chat_id)
LuaTele.sendText(msg_chat_id,msg_id, '✦︙تم تفعيل امر الزخرفه\n ✓',"md")
end
end
if text and text:match("^زخرفه (.*)$") and not Redis:get(TheXlAnD.."Raumo:myzhrfa"..msg.chat_id) then
...
if Redis:get(TheXlAnD.."Raumo:Brg"..msg.chat_id)  then
LuaTele.sendText(msg_chat_id,msg_id, '✦︙تم تعطيل امر الابراج مسبقا\n ✓',"md")
else
Redis:set(TheXlAnD.."Raumo:Brg"..msg.chat_id,"true")
...
if not Redis:get(TheXlAnD.."Raumo:Brg"..msg.chat_id)  then
LuaTele.sendText(msg_chat_id,msg_id, '✦︙تم تفعيل امر الابراج مسبقا\n ✓',"md")
else
Redis:del(TheXlAnD.."Raumo:Brg"..msg.chat_id)
...
if Redis:get(TheXlAnD.."Raumo:amrthshesh"..msg.chat_id)  then
LuaTele.sendText(msg_chat_id,msg_id, '✦︙تم تعطيل اوامر النسب مسبقاً\n ✓',"md")
else
Redis:set(TheXlAnD.."Raumo:amrthshesh"..msg.chat_id,"true")
...
if not Redis:get(TheXlAnD.."Raumo:amrthshesh"..msg.chat_id)  then
LuaTele.sendText(msg_chat_id,msg_id, '✦︙تم تفعيل اوامر النسب مسبقاً\n ✓',"md")
else
Redis:del(TheXlAnD.."Raumo:amrthshesh"..msg.chat_id)
...
if Redis:get(TheXlAnD.."Raumo:name:k"..msg.chat_id)  then
LuaTele.sendText(msg_chat_id,msg_id, '✦︙تم تعطيل معاني الاسماء مسبقا\n ✓',"md")
else
Redis:set(TheXlAnD.."Raumo:name:k"..msg.chat_id,"true")
...
if not Redis:get(TheXlAnD.."Raumo:name:k"..msg.chat_id)  then
LuaTele.sendText(msg_chat_id,msg_id, '✦︙تم تفعيل معاني الاسماء مسبقا\n ✓',"md")
else
Redis:del(TheXlAnD.."Raumo:name:k"..msg.chat_id)
LuaTele.sendText(msg_chat_id,msg_id, '✦︙تم تفعيل امر معاني الاسماء\n ✓',"md")
end
end
if text and text:match("^معنى اسم (.*)$") and not Redis:get(TheXlAnD.."Raumo:name:k"..msg.chat_id) then 
...
if Redis:get(TheXlAnD.."Raumo:calculate"..msg.chat_id)  then
LuaTele.sendText(msg_chat_id,msg_id, '✦︙تم تعطيل امر حساب العمر مسبقا\n ✓',"md")
else
Redis:set(TheXlAnD.."Raumo:calculate"..msg.chat_id,"true")
...
if not Redis:get(TheXlAnD.."Raumo:calculate"..msg.chat_id)  then
LuaTele.sendText(msg_chat_id,msg_id, '✦︙تم تفعيل امر حساب العمر مسبقا\n ✓',"md")
else
Redis:del(TheXlAnD.."Raumo:calculate"..msg.chat_id)
LuaTele.sendText(msg_chat_id,msg_id, '✦︙تم تفعيل امر حساب العمر\n ✓',"md")
end
end
if text and text:match("^احسب (.*)$") and not Redis:get(TheXlAnD.."Raumo:calculate"..msg.chat_id) then
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
Redis:del(TheXlAnD.."Raumo:Lock:AddMempar"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
Redis:del(TheXlAnD.."Raumo:Lock:Fshar"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
Redis:del(TheXlAnD.."Raumo:Lock:Taf"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
Redis:del(TheXlAnD.."Raumo:Lock:Kfr"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
Redis:del(TheXlAnD.."Raumo:Lock:Farsi"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
Redis:del(TheXlAnD.."Raumo:Lock:text"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
Redis:del(TheXlAnD.."Raumo:Lock:Join"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
Redis:del(TheXlAnD.."Raumo:Lock:Bot:kick"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end  
Redis:del(TheXlAnD.."Raumo:Lock:tagservr"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
Redis:del(TheXlAnD.."Raumo:lockpin"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
Redis:del(TheXlAnD.."Raumo:Lock:edit"..msg_chat_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
Redis:del(TheXlAnD.."Raumo:Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(TheXlAnD..'Raumo:'..lock..msg_chat_id)    
end
...
if text == "غنيلي" then
if not Redis:get(TheXlAnD.."Raumo:Status:distraction1"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"✦┇عذراً امر غنيلي معطل","md",true) end 
...
if text == "متحركه" then
if not Redis:get(TheXlAnD.."Raumo:Status:distraction2"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"✦┇عذراً امر متحركه معطل","md",true) end 
...
if text == "شعر" then
if not Redis:get(TheXlAnD.."Raumo:Status:distraction3"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"✦┇عذراً امر شعر معطل","md",true) end 
...
if text == "ميمز" then
if not Redis:get(TheXlAnD.."Raumo:Status:distraction9"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"✦┇عذراً امر ميمز معطل","md",true) end 
...
if not Redis:get(TheXlAnD.."Raumo:Status:distraction8"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"✦┇عذراً امر ريمكس معطل","md",true) end 
...
if not Redis:get(TheXlAnD.."Raumo:Status:distraction4"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"✦┇عذراً امر فلم معطل","md",true) end 
...
if not Redis:get(TheXlAnD.."Raumo:Status:distraction7"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"✦┇عذراً امر انمي معطل","md",true) end 
...
if not Redis:get(TheXlAnD.."Raumo:Status:distraction6"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"✦┇عذراً امر اغنيه معطل","md",true) end 
...
if not Redis:get(TheXlAnD.."Raumo:Status:distraction5"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"✦┇عذراً امر صوره معطل","md",true) end 
...
if text == "مسلسل" then
if not Redis:get(TheXlAnD.."Raumo:Status:distraction10"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"✦┇عذراً امر مسلسل معطل","md",true) end 
...
Redis:set(TheXlAnD.."Raumo:Set:Id:Group"..msg.chat_id,Text_Rand)
...
Redis:set(TheXlAnD.."Raumo:lockalllll"..msg_chat_id,"off")
...
Redis:set(TheXlAnD.."Raumo:lockalllll"..msg_chat_id,"on")
...
Redis:set(TheXlAnD.."Raumo:Lock:channell"..msg_chat_id,true) 
...
Redis:del(TheXlAnD.."Raumo:Lock:channell"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:hset(TheXlAnD.."Raumo:Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:hset(TheXlAnD.."Raumo:Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:hset(TheXlAnD.."Raumo:Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:hset(TheXlAnD.."Raumo:Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:hdel(TheXlAnD.."Raumo:Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Link"..msg_chat_id,"del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Link"..msg_chat_id,"ked")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Link"..msg_chat_id,"ktm")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Link"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheXlAnD.."Raumo:Lock:Link"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:User:Name"..msg_chat_id,"del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:User:Name"..msg_chat_id,"ked")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:User:Name"..msg_chat_id,"ktm")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:User:Name"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheXlAnD.."Raumo:Lock:User:Name"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:hashtak"..msg_chat_id,"del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:hashtak"..msg_chat_id,"ked")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:hashtak"..msg_chat_id,"ktm")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:hashtak"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheXlAnD.."Raumo:Lock:hashtak"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Cmd"..msg_chat_id,"del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Cmd"..msg_chat_id,"ked")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Cmd"..msg_chat_id,"ktm")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Cmd"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheXlAnD.."Raumo:Lock:Cmd"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Photo"..msg_chat_id,"del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Photo"..msg_chat_id,"ked")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Photo"..msg_chat_id,"ktm")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Photo"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheXlAnD.."Raumo:Lock:Photo"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Video"..msg_chat_id,"del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Video"..msg_chat_id,"ked")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Video"..msg_chat_id,"ktm")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Video"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheXlAnD.."Raumo:Lock:Video"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Animation"..msg_chat_id,"del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Animation"..msg_chat_id,"ked")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Animation"..msg_chat_id,"ktm")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Animation"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheXlAnD.."Raumo:Lock:Animation"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:geam"..msg_chat_id,"del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:geam"..msg_chat_id,"ked")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:geam"..msg_chat_id,"ktm")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:geam"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheXlAnD.."Raumo:Lock:geam"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Audio"..msg_chat_id,"del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Audio"..msg_chat_id,"ked")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Audio"..msg_chat_id,"ktm")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Audio"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheXlAnD.."Raumo:Lock:Audio"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:vico"..msg_chat_id,"del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:vico"..msg_chat_id,"ked")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:vico"..msg_chat_id,"ktm")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:vico"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheXlAnD.."Raumo:Lock:vico"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Keyboard"..msg_chat_id,"del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Keyboard"..msg_chat_id,"ked")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Keyboard"..msg_chat_id,"ktm")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Keyboard"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheXlAnD.."Raumo:Lock:Keyboard"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Sticker"..msg_chat_id,"del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Sticker"..msg_chat_id,"ked")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Sticker"..msg_chat_id,"ktm")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Sticker"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheXlAnD.."Raumo:Lock:Sticker"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:forward"..msg_chat_id,"del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:forward"..msg_chat_id,"ked")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:forward"..msg_chat_id,"ktm")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:forward"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheXlAnD.."Raumo:Lock:forward"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Document"..msg_chat_id,"del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Document"..msg_chat_id,"ked")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Document"..msg_chat_id,"ktm")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Document"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheXlAnD.."Raumo:Lock:Document"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Unsupported"..msg_chat_id,"del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Unsupported"..msg_chat_id,"ked")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Unsupported"..msg_chat_id,"ktm")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Unsupported"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheXlAnD.."Raumo:Lock:Unsupported"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Markdaun"..msg_chat_id,"del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Markdaun"..msg_chat_id,"ked")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Markdaun"..msg_chat_id,"ktm")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Markdaun"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheXlAnD.."Raumo:Lock:Markdaun"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Contact"..msg_chat_id,"del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Contact"..msg_chat_id,"ked")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Contact"..msg_chat_id,"ktm")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Contact"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheXlAnD.."Raumo:Lock:Contact"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Spam"..msg_chat_id,"del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Spam"..msg_chat_id,"ked")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Spam"..msg_chat_id,"ktm")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Spam"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheXlAnD.."Raumo:Lock:Spam"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Inlen"..msg_chat_id,"del")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Inlen"..msg_chat_id,"ked")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Inlen"..msg_chat_id,"ktm")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Lock:Inlen"..msg_chat_id,"kick")  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheXlAnD.."Raumo:Lock:Inlen"..msg_chat_id)  
...
Redis:setex(TheXlAnD.."Raumo:Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheXlAnD.."Raumo:Group:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"✦┇تم مسح الرابط ","md",true)             
end
if text == "الرابط" then
if not Redis:get(TheXlAnD.."Raumo:Status:Link"..msg_chat_id) then
...
--
if text == 'نزلني' then
if not Redis:get(TheXlAnD.."Raumo:Status:remMe"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"*✦┇امر نزلني تم تعطيله من قبل المدراء *","md",true)  end
...
if not Redis:get(TheXlAnD.."Raumo:Status:KickMe"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"*✦┇امر اطردني تم تعطيله من قبل المدراء *","md",true)  end
if msg.can_be_deleted_for_all_users == false then return LuaTele.sendText(msg_chat_id,msg_id,"\n*✦┇عذراً البوت ليس ادمن في المجموعة يرجى ترقيته وتفعيل الصلاحيات له *","md",true)  end
if GetInfoBot(msg).BanUser == false then return LuaTele.sendText(msg_chat_id,msg_id,'\n*✦┇البوت ليس لديه صلاحيه حظر المستخدمين* ',"md",true)  end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:get(TheXlAnD.."Raumo:Status:Welcome"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"✦┇تم تعطيل الترحيب من قبل الادمنيه","md",true) end 
local Welcome = Redis:get(TheXlAnD.."Raumo:Welcome:Group"..msg_chat_id)
if Welcome then 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheXlAnD.."Raumo:Welcome:Group"..msg_chat_id) 
...
Redis:setex(TheXlAnD.."Raumo:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheXlAnD.."Raumo:Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"✦┇تم ازالة قوانين المجموعة","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(TheXlAnD.."Raumo:Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(TheXlAnD.."Raumo:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if GetInfoBot(msg).Info == false then return LuaTele.sendText(msg_chat_id,msg_id,'\n*✦┇البوت ليس لديه صلاحيه تغيير المعلومات* ',"md",true)  end
Redis:set(TheXlAnD.."Raumo:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local list = Redis:smembers(TheXlAnD.."Raumo:List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(TheXlAnD.."Raumo:Filter:Group:"..v..msg_chat_id)  
Redis:srem(TheXlAnD.."Raumo:List:Filter"..msg_chat_id,v)  end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(TheXlAnD.."Raumo:Filter:Group:"..v..msg_chat_id)   
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD..'Raumo:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD..'Raumo:FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*✦┇ارسل الان ( ملصق ,متحركه ,صوره ,رساله ) *',"md",true)  end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local list = Redis:smembers(TheXlAnD.."Raumo:Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(TheXlAnD.."Raumo:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(TheXlAnD.."Raumo:Command:List:Group"..msg_chat_id) end
...
for k,v in pairs(list) do
Commands = Redis:get(TheXlAnD.."Raumo:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if Redis:get(TheXlAnD.."Raumo:Status:Link"..msg.chat_id) then
Statuslink = '‹ ✓ ›' else Statuslink = '‹ ✗ ›'
end
if Redis:get(TheXlAnD.."Raumo:Status:Welcome"..msg.chat_id) then
StatusWelcome = '‹ ✓ ›' else StatusWelcome = '‹ ✗ ›'
end
if Redis:get(TheXlAnD.."Raumo:Status:Id"..msg.chat_id) then
StatusId = '‹ ✓ ›' else StatusId = '‹ ✗ ›'
end
if Redis:get(TheXlAnD.."Raumo:Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '‹ ✓ ›' else StatusIdPhoto = '‹ ✗ ›'
end
if Redis:get(TheXlAnD.."Raumo:Status:Reply"..msg.chat_id) then
StatusReply = '‹ ✓ ›' else StatusReply = '‹ ✗ ›'
end
if Redis:get(TheXlAnD.."Raumo:Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '‹ ✓ ›' else StatusReplySudo = '‹ ✗ ›'
end
if Redis:get(TheXlAnD.."Raumo:Status:BanId"..msg.chat_id)  then
StatusBanId = '‹ ✓ ›' else StatusBanId = '‹ ✗ ›'
end
if Redis:get(TheXlAnD.."Raumo:Status:SetId"..msg.chat_id) then
StatusSetId = '‹ ✓ ›' else StatusSetId = '‹ ✗ ›'
end
if Redis:get(TheXlAnD.."Raumo:Status:Games"..msg.chat_id) then
StatusGames = '‹ ✓ ›' else StatusGames = '‹ ✗ ›'
end
if Redis:get(TheXlAnD.."Raumo:Status:KickMe"..msg.chat_id) then
Statuskickme = '‹ ✓ ›' else Statuskickme = '‹ ✗ ›'
end
if Redis:get(TheXlAnD.."Raumo:Status:AddMe"..msg.chat_id) then
...
if UserInfo.message == "Invalid user ID" then return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇عذراً تستطيع فقط استخدام الامر على المستخدمين ","md",true)  end
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇عذراً لا تستطيع استخدام الامر على البوت ","md",true)  end
if Redis:sismember(TheXlAnD.."Raumo:DevelopersAS:Groups",Message_Reply.sender.user_id) then
d = "المطورين الاساسيين • " else d = "" end
if Redis:sismember(TheXlAnD.."Raumo:DevelopersQ:Groups",Message_Reply.sender.user_id) then
de = "المطورين الثانويين • " else de = "" end
if Redis:sismember(TheXlAnD.."Raumo:Developers:Groups",Message_Reply.sender.user_id) then
dev = "المطورين • " else dev = "" end
if Redis:sismember(TheXlAnD.."Raumo:TheBasicsQ:Group"..msg_chat_id, Message_Reply.sender.user_id) then
mk = "المالكين • " else mk = "" end
if Redis:sismember(TheXlAnD.."Raumo:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
crr = "المنشئين الاساسيين • " else crr = "" end
if Redis:sismember(TheXlAnD..'Raumo:Originators:Group'..msg_chat_id, Message_Reply.sender.user_id) then
cr = "المنشئين • " else cr = "" end
if Redis:sismember(TheXlAnD..'Raumo:Managers:Group'..msg_chat_id, Message_Reply.sender.user_id) then
own = "المدراء • " else own = "" end
if Redis:sismember(TheXlAnD..'Raumo:Addictive:Group'..msg_chat_id, Message_Reply.sender.user_id) then
mod = "الادمنيه • " else mod = "" end
if Redis:sismember(TheXlAnD..'Raumo:Cleaner:Group'..msg_chat_id, Message_Reply.sender.user_id) then
Cle = "المنظفين • " else Cle = "" end
if Redis:sismember(TheXlAnD..'Raumo:Distinguished:Group'..msg_chat_id, Message_Reply.sender.user_id) then
vip = "المميزين • " else vip = ""
end
if The_ControllerAll(Message_Reply.sender.user_id) == true then
Rink = 1
elseif Redis:sismember(TheXlAnD.."Raumo:DevelopersAS:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(TheXlAnD.."Raumo:DevelopersQ:Groups",Message_Reply.sender.user_id)  then
Rink = 3
elseif Redis:sismember(TheXlAnD.."Raumo:Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 4
elseif Redis:sismember(TheXlAnD.."Raumo:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(TheXlAnD.."Raumo:Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(TheXlAnD.."Raumo:Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
elseif Redis:sismember(TheXlAnD.."Raumo:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 8
elseif Redis:sismember(TheXlAnD.."Raumo:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 9
elseif Redis:sismember(TheXlAnD.."Raumo:Cleaner:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 10
elseif Redis:sismember(TheXlAnD.."Raumo:TheBas:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 11
elseif Redis:sismember(TheXlAnD.."Raumo:TheBasicsQ:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 12
else
Rink = 13
end
...
Redis:srem(TheXlAnD.."Raumo:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id)
Redis:srem(TheXlAnD.."Raumo:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id)
Redis:srem(TheXlAnD.."Raumo:Cleaner:Group",Message_Reply.sender.user_id)
...
if Rink == 11 then return LuaTele.sendText(msg_chat_id,msg_id,"\n*✦┇لا يمكنك تنزيل مالك المجموعة*","md",true)  end
Redis:srem(TheXlAnD.."Raumo:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) end
...
if UserId_Info.type.is_channel == true then return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇عذراً لا تستطيع استخدام معرف قناة او كروب ","md",true)  end
if UserName and UserName:match('(%S+)[Bb][Oo][Tt]') then return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇عذراً لا تستطيع استخدام معرف البوت ","md",true)  end
if Redis:sismember(TheXlAnD.."Raumo:DevelopersAS:Groups",UserId_Info.id) then
d = "المطورين الاساسيين • " else d = "" end
if Redis:sismember(TheXlAnD.."Raumo:DevelopersQ:Groups",UserId_Info.id) then
de = "المطورين الثانويين • " else de = "" end
if Redis:sismember(TheXlAnD.."Raumo:Developers:Groups",UserId_Info.id) then
dev = "المطورين • " else dev = "" end
if Redis:sismember(TheXlAnD.."Raumo:TheBasicsQ:Group"..msg_chat_id, UserId_Info.id) then
mk = "المالكين • " else mk = "" end
if Redis:sismember(TheXlAnD.."Raumo:TheBasics:Group"..msg_chat_id, UserId_Info.id) then
crr = "المنشئين الاساسيين • " else crr = "" end
if Redis:sismember(TheXlAnD..'Raumo:Originators:Group'..msg_chat_id, UserId_Info.id) then
cr = "المنشئين • " else cr = "" end
if Redis:sismember(TheXlAnD..'Raumo:Managers:Group'..msg_chat_id, UserId_Info.id) then
own = "المدراء • " else own = "" end
if Redis:sismember(TheXlAnD..'Raumo:Addictive:Group'..msg_chat_id, UserId_Info.id) then
mod = "الادمنيه • " else mod = "" end
if Redis:sismember(TheXlAnD..'Raumo:Cleaner:Group'..msg_chat_id, UserId_Info.id) then
Cle = "المنظفين • " else Cle = "" end
if Redis:sismember(TheXlAnD..'Raumo:Distinguished:Group'..msg_chat_id, UserId_Info.id) then
vip = "المميزين • " else vip = ""
end
if The_ControllerAll(UserId_Info.id) == true then
Rink = 1
elseif Redis:sismember(TheXlAnD.."Raumo:DevelopersAS:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(TheXlAnD.."Raumo:DevelopersQ:Groups",UserId_Info.id)  then
Rink = 3
elseif Redis:sismember(TheXlAnD.."Raumo:Developers:Groups",UserId_Info.id)  then
Rink = 4
elseif Redis:sismember(TheXlAnD.."Raumo:TheBasics:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(TheXlAnD.."Raumo:Originators:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(TheXlAnD.."Raumo:Managers:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
elseif Redis:sismember(TheXlAnD.."Raumo:Addictive:Group"..msg_chat_id, UserId_Info.id) then
Rink = 8
elseif Redis:sismember(TheXlAnD.."Raumo:Distinguished:Group"..msg_chat_id, UserId_Info.id) then
Rink = 9
elseif Redis:sismember(TheXlAnD.."Raumo:Cleaner:Group"..msg_chat_id, UserId_Info.id) then
Rink = 10
elseif Redis:sismember(TheXlAnD.."Raumo:TheBas:Group"..msg_chat_id, UserId_Info.id) then
Rink = 11
elseif Redis:sismember(TheXlAnD.."Raumo:TheBasicsQ:Group"..msg_chat_id, UserId_Info.id) then
Rink = 12
else
Rink = 13
end
...
Redis:srem(TheXlAnD.."Raumo:Addictive:Group"..msg_chat_id, UserId_Info.id)
Redis:srem(TheXlAnD.."Raumo:Distinguished:Group"..msg_chat_id, UserId_Info.id)
Redis:srem(TheXlAnD.."Raumo:Cleaner:Group",UserId_Info.id)
elseif msg.DevelopersQ then
if Rink == 3 or Rink < 3 then return LuaTele.sendText(msg_chat_id,msg_id,"\n*✦┇لا يمكن تنزيل رتبه نفس رتبتك ولا اعلى من رتبتك *","md",true)  end
if Rink == 11 then return LuaTele.sendText(msg_chat_id,msg_id,"\n*✦┇لا يمكنك تنزيل مالك المجموعة *","md",true)  end
Redis:srem(TheXlAnD.."Raumo:Developers:Groups",UserId_Info.id)
...
if Rink == 8 or Rink < 8 then return LuaTele.sendText(msg_chat_id,msg_id,"\n*✦┇لا يمكن تنزيل رتبه نفس رتبتك ولا اعلى من رتبتك *","md",true)  end
if Rink == 11 then return LuaTele.sendText(msg_chat_id,msg_id,"\n*✦┇لا يمكنك تنزيل مالك المجموعة *","md",true)  end
Redis:srem(TheXlAnD.."Raumo:Distinguished:Group"..msg_chat_id, UserId_Info.id) end
return LuaTele.sendText(msg_chat_id,msg_id,"\n*✦┇تم تنزيله من ↫ ⤈\n ‹ "..d..""..de..""..dev..""..crr..""..cr..""..own..""..mod..""..vip..""..Cle..""..mk.." ›*","md",true)  end
...
if text == 'رسائلي' then
local Alsh = (Redis:get(TheXlAnD..'Raumo:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 0)
...
local Alsh = (Redis:get(TheXlAnD..'Raumo:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)
...
Redis:del(TheXlAnD..'Raumo:Num:Add:Memp'..msg.chat_id..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'✦┇تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'✦┇عدد جهاتك المضافه هنا ↫ ‹ *'..(Redis:get(TheXlAnD.."Raumo:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'* ›',"md",true)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:setex(TheXlAnD.."Raumo:Set:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
✦┇ارسل الان النص
✦┇يمكنك اضافه :
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheXlAnD.."Raumo:Set:Id:Groups")
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:setex(TheXlAnD.."Raumo:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
✦┇ارسل الان النص
✦┇يمكنك اضافه :
✦┇`#username` ↫ اسم المستخدم
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheXlAnD.."Raumo:Set:Id:Group"..msg.chat_id)
...
local Info_Members = Redis:smembers(TheXlAnD.."Raumo:DevelopersAS:Groups") 
if #Info_Members == 0 then return LuaTele.sendText(msg_chat_id,msg_id,"✦┇لا يوجد مطورين اساسيين حالياً , ","md",true)  end
Redis:del(TheXlAnD.."Raumo:DevelopersAS:Groups") 
...
local Info_Members = Redis:smembers(TheXlAnD.."Raumo:DevelopersQ:Groups") 
if #Info_Members == 0 then return LuaTele.sendText(msg_chat_id,msg_id,"✦┇لا يوجد مطورين ثانويين حالياً , ","md",true)  end
Redis:del(TheXlAnD.."Raumo:DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(TheXlAnD.."Raumo:Developers:Groups") 
if #Info_Members == 0 then return LuaTele.sendText(msg_chat_id,msg_id,"✦┇لا يوجد مطورين حالياً , ","md",true)  end
Redis:del(TheXlAnD.."Raumo:Developers:Groups") 
...
local Info_Members = Redis:smembers(TheXlAnD.."Raumo:TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then return LuaTele.sendText(msg_chat_id,msg_id,"✦┇لا يوجد مالكين في البوت ","md",true)  end
Redis:del(TheXlAnD.."Raumo:TheBasicsQ:Group"..msg_chat_id) 
...
local Info_Members = Redis:smembers(TheXlAnD.."Raumo:TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then return LuaTele.sendText(msg_chat_id,msg_id,"✦┇لا يوجد منشئين اساسيين حالياً , ","md",true)  end
Redis:del(TheXlAnD.."Raumo:TheBasics:Group"..msg_chat_id) 
...
local Info_Members = Redis:smembers(TheXlAnD.."Raumo:Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then return LuaTele.sendText(msg_chat_id,msg_id,"✦┇لا يوجد منشئين حالياً , ","md",true)  end
Redis:del(TheXlAnD.."Raumo:Originators:Group"..msg_chat_id) 
...
local Info_Members = Redis:smembers(TheXlAnD.."Raumo:Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then return LuaTele.sendText(msg_chat_id,msg_id,"✦┇لا يوجد مدراء حالياً , ","md",true)  end
Redis:del(TheXlAnD.."Raumo:Managers:Group"..msg_chat_id) 
...
local Info_Members = Redis:smembers(TheXlAnD.."Raumo:Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then return LuaTele.sendText(msg_chat_id,msg_id,"✦┇لا يوجد ادمنيه حالياً , ","md",true)  end
Redis:del(TheXlAnD.."Raumo:Addictive:Group"..msg_chat_id) 
...
Redis:del(TheXlAnD.."Raumo:Cleaner:Group"..msg_chat_id) 
...
local Info_Members = Redis:smembers(TheXlAnD.."Raumo:Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then return LuaTele.sendText(msg_chat_id,msg_id,"✦┇لا يوجد مميزين حالياً , ","md",true)  end
Redis:del(TheXlAnD.."Raumo:Distinguished:Group"..msg_chat_id) 
...
Redis:del(TheXlAnD.."Raumo:BanAll:Groups") 
Redis:del(TheXlAnD.."Raumo:ktmAll:Groups") 
...
local Info_Members = Redis:smembers(TheXlAnD.."Raumo:BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then return LuaTele.sendText(msg_chat_id,msg_id,"✦┇لا يوجد محظورين حالياً , ","md",true)  end
Redis:del(TheXlAnD.."Raumo:BanGroup:Group"..msg_chat_id) 
...
local Info_Members = Redis:smembers(TheXlAnD.."Raumo:SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then return LuaTele.sendText(msg_chat_id,msg_id,"✦┇لا يوجد مكتومين حالياً , ","md",true)  end
Redis:del(TheXlAnD.."Raumo:SilentGroup:Group"..msg_chat_id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local R = Redis:scard(TheXlAnD.."Raumo1:List:Rd:Sudo"..msg.chat_id)
local RR = Redis:scard(TheXlAnD.."Raumo:List:Manager"..msg_chat_id.."")
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local R = Redis:scard(TheXlAnD.."Raumo:List:Manager"..msg_chat_id.."")
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',
data = {{{text = '‹ الغاء ›', data = msg.sender.user_id..'/closeRD'},},}}
Redis:set(TheXlAnD.."Raumo:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(TheXlAnD.."Raumo:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local R = Redis:scard(TheXlAnD.."Raumo11:List:Rd:Sudo")
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local R = Redis:scard(TheXlAnD.."Raumo:List:Rd:Sudo")
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(TheXlAnD.."Raumo:Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:setex(TheXlAnD.."Raumo:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
✦┇ارسل لي سواء كان 
‹ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه • صوت • رساله ›
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:setex(TheXlAnD.."Raumo:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
✦┇ارسل لي سواء كان 
‹ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه • صوت • رساله ›
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:setex(TheXlAnD.."Raumo:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
✦┇ارسل لي سواء كان 
‹ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه • صوت • رساله ›
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:setex(TheXlAnD.."Raumo:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:setex(TheXlAnD.."Raumo:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(TheXlAnD..'Raumo:GetOwner:OwnerTheXlAnD'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(TheXlAnD..'Raumo:Owner:OwnerTheXlAnD'..msg_chat_id)
...
Redis:set(TheXlAnD..'Raumo:GetTexting:DevTheXlAnD'..msg_chat_id..':'..msg.sender.user_id,true)
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheXlAnD..'Raumo:Texting:DevTheXlAnD')
...
local DevText = Redis:get(TheXlAnD..'Raumo:Texting:DevTheXlAnD')
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not msg.ControllerBot then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
...
if Redis:get(TheXlAnD.."Raumo:Status:gamle"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
if Redis:get(TheXlAnD.."Raumo:Status:kool"..msg.chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,m,"md",true)  end end
if text == "صورتي" then
if Redis:get(TheXlAnD.."Raumo:Status:photo"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local L = Redis:scard(TheXlAnD.."Raumo:TheBasics:Group"..msg_chat_id) 
local LL = Redis:scard(TheXlAnD.."Raumo:Originators:Group"..msg_chat_id) 
local LLL = Redis:scard(TheXlAnD.."Raumo:Managers:Group"..msg_chat_id)
local LLLL = Redis:scard(TheXlAnD.."Raumo:Addictive:Group"..msg_chat_id)  
local LLLLL = Redis:scard(TheXlAnD.."Raumo:Distinguished:Group"..msg_chat_id)
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:setex(TheXlAnD.."Raumo:Change:Name:Bot"..msg.sender.user_id,300,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheXlAnD.."Raumo:Name:Bot") 
return LuaTele.sendText(msg_chat_id,msg_id,"✦┇تم حذف اسم البوت ","md",true)   
end
if text == (Redis:get(TheXlAnD.."Raumo:Name:Bot") or "اكسلاند") then
local NamesBot = (Redis:get(TheXlAnD.."Raumo:Name:Bot") or "اكسلاند")
local NameBots = {
"عمر "..NamesBot.. " شتريد ؟",
...
x = x + 1
Redis:srem(TheXlAnD..'Raumo:Num:User:Pv',v) end end
...
Redis:srem(TheXlAnD..'Raumo:ChekBotAdd',Get_Chat.id)
...
for i = 1, #keys do
Redis:del(keys[i]) end
Redis:srem(TheXlAnD..'Raumo:ChekBotAdd',v)
...
Redis:set(TheXlAnD.."Raumo:Game:Smile"..msg.chat_id,SM)
...
Redis:set(TheXlAnD.."Raumo:Game:Monotonous"..msg.chat_id,name)
...
Redis:set(TheXlAnD.."Raumo:Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(TheXlAnD.."Raumo:Status:Games"..msg.chat_id) then
Redis:del(TheXlAnD.."Raumo:Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(TheXlAnD.."Raumo:Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(TheXlAnD.."Raumo:Status:Games"..msg.chat_id) then
Redis:del(TheXlAnD.."Raumo:Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(TheXlAnD.."Raumo:Game:Reflection"..msg.chat_id,name)
...
Redis:set(TheXlAnD.."Raumo:Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇اهلا بك عزيزي في لعبة التخمين :\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n".."✦┇ملاحظه لديك {3} محاولات فقط فكر قبل ارسال تخمينك \n\n".."✦┇سيتم تخمين عدد ما بين ال {1 و 20} اذا تعتقد انك تستطيع الفوز جرب واللعب الان ؟ ","md",true) end end
if text == "المختلف" then
if Redis:get(TheXlAnD.."Raumo:Status:Games"..msg.chat_id) then
mktlf = {"😸","☠","🐼","🐇","🌑","🌚","⭐️","✨","⛈","🌥","⛄️","👨‍🔬","👨‍💻","👨‍🔧","👩‍🍳","🧚‍♀","🧜‍♂","🧝‍♂","🙍‍♂","🧖‍♂","👬","🕓","🕤","⌛️","📅",};
name = mktlf[math.random(#mktlf)]
Redis:set(TheXlAnD.."Raumo:Game:Difference"..msg.chat_id,name)
...
Redis:set(TheXlAnD.."Raumo:Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(TheXlAnD.."Raumo:Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(TheXlAnD.."Raumo:Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(TheXlAnD.."Raumo:Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
if UserInfo.message == "Invalid user ID" then return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇عذراً تستطيع فقط استخدام الامر على المستخدمين ","md",true)  end
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇عذراً لا تستطيع استخدام الامر على البوت ","md",true)  end
Redis:incrby(TheXlAnD.."Raumo:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
if UserInfo.message == "Invalid user ID" then return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇عذراً تستطيع فقط استخدام الامر على المستخدمين ","md",true)  end
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then return LuaTele.sendText(msg_chat_id,msg_id,"\n✦┇عذراً لا تستطيع استخدام الامر على البوت ","md",true)  end
Redis:incrby(TheXlAnD.."Raumo:Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(TheXlAnD.."Raumo:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(TheXlAnD.."Raumo:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(TheXlAnD.."Raumo:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(TheXlAnD.."Raumo:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(TheXlAnD.."Raumo:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(TheXlAnD.."Raumo:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(TheXlAnD.."Raumo:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(TheXlAnD.."Raumo:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(TheXlAnD.."Raumo:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(TheXlAnD.."Raumo:Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(TheXlAnD.."Raumo:Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(TheXlAnD.."Raumo:Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(TheXlAnD.."Raumo:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','ردود المدير')
Redis:set(TheXlAnD.."Raumo:Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(TheXlAnD.."Raumo:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(TheXlAnD.."Raumo:Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(TheXlAnD.."Raumo:Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(TheXlAnD.."Raumo:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','مسح رسائلي')
Redis:set(TheXlAnD.."Raumo:Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
Redis:set(TheXlAnD.."Raumo:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(TheXlAnD.."Raumo:Get:Reides:Commands:Group"..msg_chat_id..":"..'حذ','حذف رد')
Redis:set(TheXlAnD.."Raumo:Get:Reides:Commands:Group"..msg_chat_id..":"..'#','مسح قائمه العام')
...
download('https://raw.githubusercontent.com/REKSSTEAM/XlAnD/master/Raumo.lua','Raumo.lua')
print("\27[31;47m\n          ( تم تحديث السورس )          \n\27[0;34;49m\n") 
...
Redis:sadd(TheXlAnD..'Raumo:Num:User:Pv',msg.sender.user_id)  
if not msg.DevelopersAS then
if not Redis:get(TheXlAnD.."Raumo:Start:Bot") then
local CmdStart = '✦┇مرحبا انا بوت اسمي ‹ '..(Redis:get(TheXlAnD.."Raumo:Name:Bot") or "لار")..' ›\n✦┇اختصاصي التسليه وحماية المجموعات\n✦┇من المخربين والتفليش والسبام والخ\n✦┇فقط قم برفعي ادمن في مجموعتك\n✦┇وارسل كلمة ↫ ‹ تفعيل ›'
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ المطور ›', url = "t.me/"..UserSudo..""},},{{text = '‹ قناة السورس ›', url = 't.me/TeAm_XlAnD'},{text = '‹ لتنصيب بوت ›', url = 't.me/B333BB'},},{{text = '‹ اضفني الى مجموعتك ›', url = 't.me/'..UserBot..'?startgroup=new'},},}}
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(TheXlAnD.."Raumo:Start:Bot"),"md",false, false, false, false, reply_markup) end
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(TheXlAnD.."Raumo:Start:Bot"),"md",false, false, false, false, reply_markup) end end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:setex(TheXlAnD.."Raumo:Change:Start:Bot"..msg.sender.user_id,300,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(TheXlAnD.."Raumo:Start:Bot") 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(TheXlAnD..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local list = Redis:smembers(TheXlAnD.."Raumo:List:Rd:Sudo")
text = "\n✦┇قائمة ردود المطور ↫ ⤈\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
if Redis:get(TheXlAnD.."Raumo:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(TheXlAnD.."Raumo:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(TheXlAnD.."Raumo:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(TheXlAnD.."Raumo:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(TheXlAnD.."Raumo:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(TheXlAnD.."Raumo:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(TheXlAnD.."Raumo:Add:Rd:Sudo:File"..v) then
db = "ملف 📁"
elseif Redis:get(TheXlAnD.."Raumo:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه ??"
elseif Redis:get(TheXlAnD.."Raumo:Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." - ‹ "..v.." › ↫ ‹"..db.."›\n"
end
...
local list = Redis:smembers(TheXlAnD.."Raumo:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(TheXlAnD.."Raumo:Add:Rd:Sudo:Gif"..v)   
Redis:del(TheXlAnD.."Raumo:Add:Rd:Sudo:vico"..v)   
Redis:del(TheXlAnD.."Raumo:Add:Rd:Sudo:stekr"..v)     
Redis:del(TheXlAnD.."Raumo:Add:Rd:Sudo:Text"..v)   
Redis:del(TheXlAnD.."Raumo:Add:Rd:Sudo:Photo"..v)
Redis:del(TheXlAnD.."Raumo:Add:Rd:Sudo:Video"..v)
Redis:del(TheXlAnD.."Raumo:Add:Rd:Sudo:File"..v)
Redis:del(TheXlAnD.."Raumo:Add:Rd:Sudo:Audio"..v)
Redis:del(TheXlAnD.."Raumo:Add:Rd:Sudo:video_note"..v)
Redis:del(TheXlAnD.."Raumo:List:Rd:Sudo") end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"✦┇تم الغاء كتمه عام من المجموعات  ").Reply,"md",true) end end
if not msg.DevelopersAS then
if Redis:get(TheXlAnD.."Raumo:TwaslBot") and not Redis:sismember(TheXlAnD.."Raumo:BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(TheXlAnD.."Raumo:Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(TheXlAnD.."Raumo:Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(TheXlAnD..'Raumo:BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'✦┇تم حظره من تواصل البوت ').Reply,"md",true)  end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(TheXlAnD..'Raumo:BaN:In:Tuasl',Info_User)  
...
Redis:srem(TheXlAnD.."Raumo:ChekBotAdd",'-100'..data.supergroup.id)
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(TheXlAnD.."Raumo:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheXlAnD.."Raumo:PinMsegees:"..msg.chat_id) end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
if idPhoto == Redis:get(TheXlAnD.."Raumo:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheXlAnD.."Raumo:PinMsegees:"..msg.chat_id) end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(TheXlAnD.."Raumo:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheXlAnD.."Raumo:PinMsegees:"..msg.chat_id) end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(TheXlAnD.."Raumo:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheXlAnD.."Raumo:PinMsegees:"..msg.chat_id) end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(TheXlAnD.."Raumo:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheXlAnD.."Raumo:PinMsegees:"..msg.chat_id) end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(TheXlAnD.."Raumo:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheXlAnD.."Raumo:PinMsegees:"..msg.chat_id) end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(TheXlAnD.."Raumo:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheXlAnD.."Raumo:PinMsegees:"..msg.chat_id) end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(TheXlAnD.."Raumo:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheXlAnD.."Raumo:PinMsegees:"..msg.chat_id) end
elseif text then
if text == Redis:get(TheXlAnD.."Raumo:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheXlAnD.."Raumo:PinMsegees:"..msg.chat_id) end end

elseif data and data.luatele and data.luatele == "updateNewMessage" then
if data.message.content.luatele == "messageChatDeleteMember" or data.message.content.luatele == "messageChatAddMembers" or data.message.content.luatele == "messagePinMessage" or data.message.content.luatele == "messageChatChangeTitle" or data.message.content.luatele == "messageChatJoinByLink" then
if Redis:get(TheXlAnD.."Raumo:Lock:tagservr"..data.message.chat_id) then
...
Redis:incr(TheXlAnD..'Raumo:Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(TheXlAnD.."Raumo:Lock:edit"..data.chat_id) then
...
if tonumber(IdUser) == tonumber(UserId) then
local list = Redis:smembers(TheXlAnD.."Raumo:allM"..data.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
t = "✦┇تم حذف ‹ "..k.." › من الميديا"
LuaTele.deleteMessages(data.chat_id,{[1]= Message})
Redis:del(TheXlAnD.."Raumo:allM"..data.chat_id) end end
if #list == 0 then
t = "✦┇لا توجد ميديا في المجموعة"
end
...
if tonumber(IdUser) == tonumber(UserId) then
if not Redis:get(TheXlAnD.."Raumo:Status:distraction1"..data.chat_id) then return LuaTele.answerCallbackQuery(data.id,"✦┇عذراً امر غنيلي معطل",true) end 
Abs = math.random(4,2824); 
local Text ='✦┇تم اختيار المقطع الصوتي لك'
keyboard = {} 
...
if tonumber(IdUser) == tonumber(UserId) then
if not Redis:get(TheXlAnD.."Raumo:Status:distraction2"..data.chat_id) then return LuaTele.answerCallbackQuery(data.id,"✦┇عذراً امر متحركه معطل",true) end 
Abs = math.random(4,1075); 
local Text ='✦┇تم اختيار المتحركه لك'
keyboard = {} 
...
if tonumber(IdUser) == tonumber(UserId) then
if not Redis:get(TheXlAnD.."Raumo:Status:distraction3"..data.chat_id) then return LuaTele.answerCallbackQuery(data.id,"✦┇عذراً امر شعر معطل",true) end 
Abs = math.random(4,140); 
local Text ='✦┇تم اختيار الشعر لك'
keyboard = {} 
...
if tonumber(IdUser) == tonumber(UserId) then
if not Redis:get(TheXlAnD.."Raumo:Status:distraction4"..data.chat_id) then return LuaTele.answerCallbackQuery(data.id,"✦┇عذراً امر ميمز معطل",true) end 
Abs = math.random(4,1201); 
local Text ='✦┇تم اختيار الميمز لك'
keyboard = {} 
...
if tonumber(IdUser) == tonumber(UserId) then
if not Redis:get(TheXlAnD.."Raumo:Status:distraction5"..data.chat_id) then return LuaTele.answerCallbackQuery(data.id,"✦┇عذراً امر ريمكس معطل",true) end 
Abs = math.random(4,612); 
...
if tonumber(IdUser) == tonumber(UserId) then
if not Redis:get(TheXlAnD.."Raumo:Status:distraction6"..data.chat_id) then return LuaTele.answerCallbackQuery(data.id,"✦┇عذراً امر فلم معطل",true) end 
Abs = math.random(4,125); 
local Text ='✦┇تم اختيار الفلم لك'
keyboard = {} 
...
if tonumber(IdUser) == tonumber(UserId) then
if not Redis:get(TheXlAnD.."Raumo:Status:distraction7"..data.chat_id) then return LuaTele.answerCallbackQuery(data.id,"✦┇عذراً امر انمي معطل",true) end 
Abs = math.random(4,1002); 
local Text ='✦┇تم اختيار الانمي لك'
keyboard = {} 
...
if tonumber(IdUser) == tonumber(UserId) then
if not Redis:get(TheXlAnD.."Raumo:Status:distraction8"..data.chat_id) then return LuaTele.answerCallbackQuery(data.id,"✦┇عذراً امر اغنيه معطل",true) end 
Abs = math.random(4,1167); 
local Text ='✦┇تم اختيار الاغنيه لك'
keyboard = {} 
...
if tonumber(IdUser) == tonumber(UserId) then
if not Redis:get(TheXlAnD.."Raumo:Status:distraction9"..data.chat_id) then return LuaTele.answerCallbackQuery(data.id,"✦┇عذراً امر صوره معطل",true) end 
Abs = math.random(4,1171); 
local Text ='✦┇تم اختيار الصوره لك'
keyboard = {} 
...
if tonumber(IdUser) == tonumber(UserId) then
if not Redis:get(TheXlAnD.."Raumo:Status:distraction10"..data.chat_id) then return LuaTele.answerCallbackQuery(data.id,"✦┇عذراً امر مسلسل معطل",true) end 
Abs = math.random(4,54); 
local Text ='✦┇تم اختيار المسلسل لك'
keyboard = {} 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Set:Manager:rd"..data.sender_user_id..":"..data.chat_id)
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD..'Raumo:GetTexting:DevTheXlAnD'..data.chat_id..':'..data.sender_user_id)
return LuaTele.editMessageText(ChatId,Msg_id,'✦┇تم الغاء الامر',"md",true) end end
--
if Text and Text:match('(%d+)/DelOwner') then
local UserId = Text:match('(%d+)/DelOwner')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD..'Raumo:GetOwner:OwnerTheXlAnD'..data.chat_id..':'..data.sender_user_id)
return LuaTele.editMessageText(ChatId,Msg_id,'✦┇تم الغاء الامر',"md",true) end end
--
if Text and Text:match('(%d+)/closerdControllerBot') then
local UserId = Text:match('(%d+)/closerdControllerBot')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo11:Set:Rd"..data.sender_user_id..":"..data.chat_id)
return LuaTele.editMessageText(ChatId,Msg_id,'✦┇تم الغاء الامر',"md",true) end end
--
if Text and Text:match('(%d+)/closerd0bot') then
local UserId = Text:match('(%d+)/closerd0bot')
if tonumber(IdUser) == tonumber(UserId) then
local test = Redis:get(TheXlAnD.."Raumo11:Text:Sudo:Bot"..data.sender_user_id..":"..data.chat_id)
Redis:del(TheXlAnD..'Raumo11:Add:Rd:Sudo:Text'..test)
Redis:del(TheXlAnD..'Raumo11:Add:Rd:Sudo:Text1'..test)
Redis:del(TheXlAnD..'Raumo11:Add:Rd:Sudo:Text2'..test)
Redis:del(TheXlAnD.."Raumo11:Set:Rd"..data.sender_user_id..":"..data.chat_id)
Redis:srem(TheXlAnD.."Raumo11:List:Rd:Sudo", test)
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo11:Set:On"..data.sender_user_id..":"..data.chat_id)
return LuaTele.editMessageText(ChatId,Msg_id,'✦┇تم الغاء الامر',"md",true) end end
---- Alsh
if Text and Text:match('(%d+)/closerdManagers') then
local UserId = Text:match('(%d+)/closerdManagers')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo1:Set:Rd"..data.sender_user_id..":"..data.chat_id)
return LuaTele.editMessageText(ChatId,Msg_id,'✦┇تم الغاء الامر',"md",true) end end
--
if Text and Text:match('(%d+)/closerd0') then
local UserId = Text:match('(%d+)/closerd0')
if tonumber(IdUser) == tonumber(UserId) then
local test = Redis:get(TheXlAnD.."Raumo1:Text:Sudo:Bot"..data.sender_user_id..":"..data.chat_id)
Redis:del(TheXlAnD..'Raumo1:Add:Rd:Sudo:Text'..test..data.chat_id)
Redis:del(TheXlAnD..'Raumo1:Add:Rd:Sudo:Text1'..test..data.chat_id)
Redis:del(TheXlAnD..'Raumo1:Add:Rd:Sudo:Text2'..test..data.chat_id)
Redis:del(TheXlAnD..'Raumo1:Add:Rd:Sudo:Text3'..test..data.chat_id)
Redis:del(TheXlAnD..'Raumo1:Add:Rd:Sudo:Text4'..test..data.chat_id)
Redis:del(TheXlAnD.."Raumo1:Set:Rd"..data.sender_user_id..":"..data.chat_id)
Redis:srem(TheXlAnD.."Raumo1:List:Rd:Sudo"..data.chat_id, test)
return LuaTele.editMessageText(ChatId,Msg_id,'✦┇تم الغاء حفظ الرد',"md",true) end end
--
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo1:Set:On"..data.sender_user_id..":"..data.chat_id)
return LuaTele.editMessageText(ChatId,Msg_id,'✦┇تم الغاء الامر',"md",true) end end
-- Alsh
if Text and Text:match('(%d+)/closeRules') then
local UserId = Text:match('(%d+)/closeRules')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Set:Rules:" .. data.chat_id .. ":" .. data.sender_user_id)
return LuaTele.editMessageText(ChatId,Msg_id,'✦┇تم الغاء الامر',"md",true) end end
--
if Text and Text:match('(%d+)/closeDescription') then
local UserId = Text:match('(%d+)/closeDescription')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Set:Description:" .. data.chat_id .. ":" .. data.sender_user_id)
return LuaTele.editMessageText(ChatId,Msg_id,'✦┇تم الغاء الامر',"md",true) end end
--
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Set:Link"..data.chat_id..""..data.sender_user_id) 
return LuaTele.editMessageText(ChatId,Msg_id,'✦┇تم الغاء الامر',"md",true) end end
-- Alsh
...
local UserId = Text:match('(%d+)/closerd')
if tonumber(IdUser) == tonumber(UserId) then
local test = Redis:get(TheXlAnD.."Raumo:Text:Manager"..data.sender_user_id..":"..data.chat_id.."")
Redis:del(TheXlAnD.."Raumo:Add:Rd:Manager:Gif"..test..data.chat_id)   
Redis:del(TheXlAnD.."Raumo:Add:Rd:Manager:Vico"..test..data.chat_id)   
Redis:del(TheXlAnD.."Raumo:Add:Rd:Manager:Stekrs"..test..data.chat_id)     
Redis:del(TheXlAnD.."Raumo:Add:Rd:Manager:Text"..test..data.chat_id)   
Redis:del(TheXlAnD.."Raumo:Add:Rd:Manager:Photo"..test..data.chat_id)
Redis:del(TheXlAnD.."Raumo:Add:Rd:Manager:Video"..test..data.chat_id)
Redis:del(TheXlAnD.."Raumo:Add:Rd:Manager:File"..test..data.chat_id)
Redis:del(TheXlAnD.."Raumo:Add:Rd:Manager:Audio"..test..data.chat_id)
Redis:del(TheXlAnD.."Raumo:Add:Rd:Manager:video_note"..test..data.chat_id)
Redis:del(TheXlAnD.."Raumo:Set:Manager:rd"..data.sender_user_id..":"..data.chat_id)
Redis:srem(TheXlAnD.."Raumo:List:Manager"..data.chat_id.."", test)
return LuaTele.editMessageText(ChatId,Msg_id,'✦┇تم الغاء حفظ الرد',"md",true) end end
--
if Text and Text:match('(%d+)/closerD') then
local UserId = Text:match('(%d+)/closerD')
...
Rink = 1
elseif Redis:sismember(TheXlAnD.."Raumo:DevelopersAS:Groups",IdUser)  then
Rink = 2
elseif Redis:sismember(TheXlAnD.."Raumo:DevelopersQ:Groups",IdUser)  then
Rink = 3
elseif Redis:sismember(TheXlAnD.."Raumo:Developers:Groups",IdUser)  then
Rink = 4
elseif Redis:sismember(TheXlAnD.."Raumo:TheBasics:Group"..data.chat_id, IdUser) then
Rink = 5
elseif Redis:sismember(TheXlAnD.."Raumo:Originators:Group"..data.chat_id, IdUser) then
Rink = 6
elseif Redis:sismember(TheXlAnD.."Raumo:Managers:Group"..data.chat_id, IdUser) then
Rink = 7
elseif Redis:sismember(TheXlAnD.."Raumo:Addictive:Group"..data.chat_id, IdUser) then
Rink = 8
elseif Redis:sismember(TheXlAnD.."Raumo:Distinguished:Group"..data.chat_id, IdUser) then
Rink = 9
elseif Redis:sismember(TheXlAnD.."Raumo:Cleaner:Group"..data.chat_id, IdUser) then
Rink = 10
else
Rink = 11
end
...
Redis:srem(TheXlAnD.."Raumo:DevelopersAS:Groups", IdUser)
Redis:srem(TheXlAnD.."Raumo:DevelopersQ:Groups", IdUser)
Redis:srem(TheXlAnD.."Raumo:Developers:Groups", IdUser)
Redis:srem(TheXlAnD.."Raumo:TheBasics:Group"..data.chat_id, IdUser)
Redis:srem(TheXlAnD.."Raumo:Originators:Group"..data.chat_id, IdUser)
Redis:srem(TheXlAnD.."Raumo:Managers:Group"..data.chat_id, IdUser)
Redis:srem(TheXlAnD.."Raumo:Addictive:Group"..data.chat_id, IdUser)
Redis:srem(TheXlAnD.."Raumo:Distinguished:Group"..data.chat_id, IdUser)
Redis:srem(TheXlAnD.."Raumo:Cleaner:Group"..data.chat_id, IdUser)
...
Redis:srem(TheXlAnD..'Raumo:ChekBotAdd',data.chat_id)
...
if tonumber(IdUser) == tonumber(UserId) then
local Rds = Redis:scard(TheXlAnD.."Raumo:List:Rd:Sudo")
local list = Redis:smembers(TheXlAnD.."Raumo:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(TheXlAnD.."Raumo:Add:Rd:Sudo:Gif"..v)   
Redis:del(TheXlAnD.."Raumo:Add:Rd:Sudo:vico"..v)   
...
if tonumber(IdUser) == tonumber(UserId) then 
local list = Redis:smembers(TheXlAnD.."Raumo11:List:Rd:Sudo")
...
local list = Redis:smembers(TheXlAnD.."Raumo11:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(TheXlAnD.."Raumo11:Add:Rd:Sudo:Text"..v) 
Redis:del(TheXlAnD.."Raumo11:Add:Rd:Sudo:Text1"..v) 
Redis:del(TheXlAnD.."Raumo11:Add:Rd:Sudo:Text2"..v)   
Redis:del(TheXlAnD.."Raumo11:List:Rd:Sudo") end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Set:On"..data.sender_user_id..":"..data.chat_id)
return LuaTele.editMessageText(ChatId,Msg_id,'✦┇تم الغاء الامر',"md",true) end end
--
if Text and Text:match('(%d+)/DevIDClose') then
local UserId = Text:match('(%d+)/DevIDClose')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:AddSudosNew"..data.chat_id)
return LuaTele.editMessageText(ChatId,Msg_id,'✦┇تم الغاء الامر',"md",true) end end
-- Alsh --
if Text and Text:match('(%d+)/RdAlsh') then
local UserId = Text:match('(%d+)/RdAlsh')
if tonumber(IdUser) == tonumber(UserId) then 
local list = Redis:smembers(TheXlAnD.."Raumo1:List:Rd:Sudo"..data.chat_id)
...
local UserId = Text:match('(%d+)/RdAlsh')
if tonumber(IdUser) == tonumber(UserId) then
local R = Redis:scard(TheXlAnD.."Raumo1:List:Rd:Sudo"..data.chat_id)
local list = Redis:smembers(TheXlAnD.."Raumo1:List:Rd:Sudo"..data.chat_id)
for k,v in pairs(list) do  
Redis:del(TheXlAnD.."Raumo1:Add:Rd:Sudo:Text"..v..data.chat_id) 
Redis:del(TheXlAnD.."Raumo1:Add:Rd:Sudo:Text1"..v..data.chat_id) 
Redis:del(TheXlAnD.."Raumo1:Add:Rd:Sudo:Text2"..v..data.chat_id) 
Redis:del(TheXlAnD.."Raumo1:List:Rd:Sudo"..data.chat_id) end
...
if tonumber(IdUser) == tonumber(UserId) then 
local list = Redis:smembers(TheXlAnD.."Raumo:List:Manager"..data.chat_id.."")
Alsh = "✦┇قائمة ردود المدير ↫ ⤈\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
if Redis:get(TheXlAnD.."Raumo:Add:Rd:Manager:Gif"..v..data.chat_id) then
db = "متحركه 🎭"
elseif Redis:get(TheXlAnD.."Raumo:Add:Rd:Manager:Vico"..v..data.chat_id) then
db = "بصمه 📢"
elseif Redis:get(TheXlAnD.."Raumo:Add:Rd:Manager:Stekrs"..v..data.chat_id) then
db = "ملصق 🃏"
elseif Redis:get(TheXlAnD.."Raumo:Add:Rd:Manager:Text"..v..data.chat_id) then
db = "رساله ✉"
elseif Redis:get(TheXlAnD.."Raumo:Add:Rd:Manager:Photo"..v..data.chat_id) then
db = "صوره 🎇"
elseif Redis:get(TheXlAnD.."Raumo:Add:Rd:Manager:Video"..v..data.chat_id) then
db = "فيديو 📹"
elseif Redis:get(TheXlAnD.."Raumo:Add:Rd:Manager:File"..v..data.chat_id) then
db = "ملف 📁"
elseif Redis:get(TheXlAnD.."Raumo:Add:Rd:Manager:Audio"..v..data.chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(TheXlAnD.."Raumo:Add:Rd:Manager:video_note"..v..data.chat_id) then
db = "فيديو نوت 🎥"
end
Alsh = Alsh..""..k.." - ‹ `"..v.."` › ↫ ‹"..db.."›\n"
end
...
if tonumber(IdUser) == tonumber(UserId) then
local R = Redis:scard(TheXlAnD.."Raumo:List:Manager"..data.chat_id.."")
local list = Redis:smembers(TheXlAnD.."Raumo:List:Manager"..data.chat_id.."")
for k,v in pairs(list) do
Redis:del(TheXlAnD.."Raumo:Add:Rd:Manager:Gif"..v..data.chat_id)   
Redis:del(TheXlAnD.."Raumo:Add:Rd:Manager:Vico"..v..data.chat_id)   
Redis:del(TheXlAnD.."Raumo:Add:Rd:Manager:Stekrs"..v..data.chat_id)     
Redis:del(TheXlAnD.."Raumo:Add:Rd:Manager:Text"..v..data.chat_id)   
Redis:del(TheXlAnD.."Raumo:Add:Rd:Manager:Photo"..v..data.chat_id)
Redis:del(TheXlAnD.."Raumo:Add:Rd:Manager:Video"..v..data.chat_id)
Redis:del(TheXlAnD.."Raumo:Add:Rd:Manager:File"..v..data.chat_id)
Redis:del(TheXlAnD.."Raumo:Add:Rd:Manager:video_note"..v..data.chat_id)
Redis:del(TheXlAnD.."Raumo:Add:Rd:Manager:Audio"..v..data.chat_id)
Redis:del(TheXlAnD.."Raumo:List:Manager"..data.chat_id) end
...
if Redis:sismember(TheXlAnD.."Raumo:ChekBotAdd",data.chat_id) then return LuaTele.editMessageText(ChatId,Msg_id, '\n✦┇المجموعة تم تفعيلها بالتأكيد' ,"md",true)  
else
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TheXlAnD.."Raumo:TheBas:Group"..data.chat_id,v.member_id.user_id) 
x = x + 1 end end
end
...
Redis:sadd(TheXlAnD.."Raumo:ChekBotAdd",data.chat_id)
Redis:set(TheXlAnD.."Raumo:Status:Id"..data.chat_id,true) ;Redis:set(TheXlAnD.."Raumo:Status:Reply"..data.chat_id,true) ;Redis:set(TheXlAnD.."Raumo:Status:ReplySudo"..data.chat_id,true) ;Redis:set(TheXlAnD.."Raumo:Status:BanId"..data.chat_id,true) ;Redis:set(TheXlAnD.."Raumo:Status:SetId"..data.chat_id,true) 
...
local Get_Chat = LuaTele.getChat(data.chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(data.chat_id)
if not Redis:sismember(TheXlAnD.."Raumo:ChekBotAdd",data.chat_id) then return LuaTele.editMessageText(ChatId,Msg_id, '\n✦┇المجموعة تم تعطيلها بالتأكيد',"md",true)  
else
...
if tonumber(IdUser) == tonumber(UserId) then 
local Get_Chat = LuaTele.getChat(data.chat_id) 
local GetLink = Redis:get(TheXlAnD.."Raumo:Group:Link"..data.chat_id) 
if GetLink then
...
Redis:incrby(TheXlAnD.."Raumo:Num:Add:Games"..ChatId..IdUser, 1)  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheXlAnD.."Raumo:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheXlAnD.."Raumo:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheXlAnD.."Raumo:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheXlAnD.."Raumo:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheXlAnD.."Raumo:Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele ~= "chatMemberStatusCreator" then
Redis:sadd(TheXlAnD.."Raumo:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1 end end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(TheXlAnD.."Raumo:Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(TheXlAnD..'Raumo:'..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId) then
local MMsgDel = (Redis:get(TheXlAnD..'Raumo:Num:Message:User'..data.chat_id..':'..UserId) or 0)
Redis:del(TheXlAnD..'Raumo:Num:Message:User'..data.chat_id..':'..UserId) 
...
if tonumber(IdUser) == tonumber(UserId) then
local MsgDell = (Redis:get(TheXlAnD..'Raumo:Num:Message:Edit'..data.chat_id..UserId) or 0)
Redis:del(TheXlAnD..'Raumo:Num:Message:Edit'..data.chat_id..UserId)
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'Rgg'},},}}
...
local Info_Members = Redis:smembers(TheXlAnD.."Raumo:TheBasics:Group"..data.chat_id) 
...
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'RgoAAlsh'},},}}
local Info_Members = Redis:smembers(TheXlAnD.."Raumo:Originators:Group"..data.chat_id) 
...
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'RgoAAlsh'},},}}
local Info_Members = Redis:smembers(TheXlAnD.."Raumo:Managers:Group"..data.chat_id) 
...
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'RgoAAlsh'},},}}
local Info_Members = Redis:smembers(TheXlAnD.."Raumo:Addictive:Group"..data.chat_id) 
...
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'RgoAAlsh'},},}}
local Info_Members = Redis:smembers(TheXlAnD.."Raumo:Distinguished:Group"..data.chat_id) 
...
local L = Redis:scard(TheXlAnD.."Raumo:TheBasics:Group"..data.chat_id) 
local LL = Redis:scard(TheXlAnD.."Raumo:Originators:Group"..data.chat_id) 
local LLL = Redis:scard(TheXlAnD.."Raumo:Managers:Group"..data.chat_id)
local LLLL = Redis:scard(TheXlAnD.."Raumo:Addictive:Group"..data.chat_id)  
local LLLLL = Redis:scard(TheXlAnD.."Raumo:Distinguished:Group"..data.chat_id)
...
if tonumber(IdUser) == tonumber(UserId) then
local Alsh = (Redis:get(TheXlAnD..'Raumo:Num:Message:Edit'..data.chat_id..UserId) or 0)
local Alsh = (Redis:get(TheXlAnD..'Raumo:Num:Message:User'..data.chat_id..':'..UserId) or 0)
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(TheXlAnD.."Raumo:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:TheBasics:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'RgoA'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Originators:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'RgoA'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Managers:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'RgoA'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Addictive:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'RgoA'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'RgoA'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:Cleaner:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:BanGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"✦┇تم مسح المحظورين بالمجموعة", 'md', false) end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheXlAnD.."Raumo:SilentGroup:Group"..ChatId) 
